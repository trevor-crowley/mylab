set C_TypeInfoList {{ 
"mandelbrot" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"re": [[], {"scalar": "double"}] }, {"im": [[], {"scalar": "double"}] }, {"outp": [[],{ "pointer":  {"scalar": "short"}}] }],[],""]
}}
...
set C_modelArgList {
	{ re double 64 regular  }
	{ im double 64 regular  }
	{ outp int 16 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "re", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[{"low":0,"up":63,"cElement": [{"cName": "re","cData": "double","bit_use": { "low": 0,"up": 63},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
 	{ "Name" : "im", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[{"low":0,"up":63,"cElement": [{"cName": "im","cData": "double","bit_use": { "low": 0,"up": 63},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
...
set portList { 
	...
	{ re sc_in sc_lv 64 signal 0 } 
	{ im sc_in sc_lv 64 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "re", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "re", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mandelbrot_dcmp_6dEe_U4", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	mandelbrot {
		...
		outp {Type O LastRead -1 FirstWrite 6}}}
