...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.GEN_F0_VBLANK_HEND {10} \
   CONFIG.GEN_F0_VBLANK_HSTART {10} \
   CONFIG.GEN_F0_VFRAME_SIZE {10} \
   CONFIG.GEN_F0_VSYNC_HEND {10} \
   CONFIG.GEN_F0_VSYNC_HSTART {10} \
   CONFIG.GEN_F0_VSYNC_VEND {8} \
   CONFIG.GEN_F0_VSYNC_VSTART {7} \
   ...
   CONFIG.GEN_HACTIVE_SIZE {10} \
   CONFIG.GEN_HFRAME_SIZE {14} \
   CONFIG.GEN_HSYNC_END {12} \
   CONFIG.GEN_HSYNC_START {11} \
   CONFIG.GEN_VACTIVE_SIZE {6} \
  ...
  connect_bd_net -net aclk_1 [get_bd_ports aclk] [get_bd_pins axi_vip_0/aclk] [get_bd_pins processing_0_axi_periph/ACLK] [get_bd_pins processing_0_axi_periph/M00_ACLK] [get_bd_pins processing_0_axi_periph/M01_ACLK] [get_bd_pins processing_0_axi_periph/M02_ACLK] [get_bd_pins processing_0_axi_periph/S00_ACLK] [get_bd_pins rst_clk_wiz_0_148M/slowest_sync_clk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins v_tc_0/clk] [get_bd_pins v_tc_0/s_axi_aclk] [get_bd_pins v_tpg_0/ap_clk] [get_bd_pins v_tpg_1/ap_clk]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A40000 [get_bd_addr_spaces axi_vip_0/Master_AXI] [get_bd_addr_segs v_tc_0/ctrl/Reg] SEG_v_tc_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x44A00000 [get_bd_addr_spaces axi_vip_0/Master_AXI] [get_bd_addr_segs v_tpg_0/s_axi_CTRL/Reg] SEG_v_tpg_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x44A10000 [get_bd_addr_spaces axi_vip_0/Master_AXI] [get_bd_addr_segs v_tpg_1/s_axi_CTRL/Reg] SEG_v_tpg_1_Reg
