...
wire   [11:0] tmp_93_cast_fu_192_p1;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_48)) begin
        if ((tmp_90_fu_180_p2 == 1'd1)) begin
            hBarSel_4_0 <= 3'd0;
        end else if (((tmp_95_fu_215_p2 == 1'd0) & (tmp_90_fu_180_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_48)) begin
        if ((tmp_90_fu_180_p2 == 1'd1)) begin
            xBar_V_0 <= 11'd0;
        end else if (((tmp_95_fu_215_p2 == 1'd1) & (tmp_90_fu_180_p2 == 1'd0))) begin
...
assign Scalar_val_0_V_writ_fu_322_p3 = ((tmp_91_fu_186_p2[0:0] === 1'b1) ? tpgBarSelRgb_r_load_s_fu_314_p3 : tpgBarSelYuv_y390_q0);

assign Scalar_val_1_V_writ_fu_344_p3 = ((sel_tmp4_reg_422[0:0] === 1'b1) ? tpgBarSelYuv_v384_q0 : sel_tmp_fu_337_p3);

assign Scalar_val_2_V_writ_fu_359_p3 = ((tmp_91_fu_186_p2[0:0] === 1'b1) ? tpgBarSelRgb_b_load_s_fu_351_p3 : tpgBarSelYuv_v384_q0);
...
assign sel_tmp1_fu_290_p2 = (tmp_91_fu_186_p2 ^ 1'd1);

assign sel_tmp2_fu_296_p2 = ((color != 8'd1) ? 1'b1 : 1'b0);

assign sel_tmp4_fu_308_p2 = (tmp_fu_302_p2 & sel_tmp2_fu_296_p2);

assign sel_tmp_fu_337_p3 = ((tmp_91_fu_186_p2[0:0] === 1'b1) ? tpgBarSelRgb_g_load_s_fu_329_p3 : tpgBarSelYuv_u387_q0);

assign tmp_100_fu_276_p1 = ap_phi_mux_hBarSel_4_0_loc_phi_fu_151_p6;

assign tmp_102_fu_160_p1 = width[13:0];

assign tmp_103_fu_286_p1 = x[0:0];

assign tmp_90_fu_180_p2 = ((x == 16'd0) ? 1'b1 : 1'b0);

assign tmp_91_fu_186_p2 = ((color == 8'd0) ? 1'b1 : 1'b0);

assign tmp_93_cast_fu_192_p1 = barWidth_V_fu_170_p4;

assign tmp_95_fu_215_p2 = ((r_V_fu_209_p2 < tmp_93_cast_fu_192_p1) ? 1'b1 : 1'b0);
...
assign tpgBarSelRgb_b399_address0 = tmp_100_fu_276_p1;

assign tpgBarSelRgb_b_load_s_fu_351_p3 = ((tpgBarSelRgb_b399_q0[0:0] === 1'b1) ? 8'd255 : 8'd0);

assign tpgBarSelRgb_g396_address0 = tmp_100_fu_276_p1;

assign tpgBarSelRgb_g_load_s_fu_329_p3 = ((tpgBarSelRgb_g396_q0[0:0] === 1'b1) ? 8'd255 : 8'd0);

assign tpgBarSelRgb_r393_address0 = tmp_100_fu_276_p1;

assign tpgBarSelRgb_r_load_s_fu_314_p3 = ((tpgBarSelRgb_r393_q0[0:0] === 1'b1) ? 8'd255 : 8'd0);

assign tpgBarSelYuv_u387_address0 = tmp_100_fu_276_p1;

assign tpgBarSelYuv_v384_address0 = tmp_100_fu_276_p1;

assign tpgBarSelYuv_y390_address0 = tmp_100_fu_276_p1;
