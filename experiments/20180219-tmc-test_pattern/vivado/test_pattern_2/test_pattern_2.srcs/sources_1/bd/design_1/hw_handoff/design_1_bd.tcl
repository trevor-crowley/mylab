...
proc create_root_design { parentCell } {
  ...
  set gpio_lock [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 gpio_lock ]
  ...
  set gen_clken [ create_bd_port -dir I gen_clken ]
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO2 [get_bd_intf_ports gpio_lock] [get_bd_intf_pins axi_gpio_0/GPIO2]
  ...
  # Create port connections
  connect_bd_net -net clk_wiz_0_clk_vid [get_bd_pins clk_wiz_0/clk_vid] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins v_tc_0/clk]
  ...
  connect_bd_net -net clken_1 [get_bd_ports clken] [get_bd_pins v_tc_0/clken]
  connect_bd_net -net gen_clken_1 [get_bd_ports gen_clken] [get_bd_pins v_tc_0/gen_clken]
  connect_bd_net -net mdm_1_debug_sys_rst [get_bd_pins mdm_1/Debug_SYS_Rst] [get_bd_pins rst_clk_wiz_0_100M/mb_debug_sys_rst]
  connect_bd_net -net microblaze_0_Clk [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_ap] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_0_100M/slowest_sync_clk]
