...
entity design_1_v_tpg_0_1_tpgPatternTartanCEe0_rom is 
    generic(
             dwidth     : integer := 3; 
             awidth     : integer := 6; 
             mem_size    : integer := 64
...
architecture rtl of design_1_v_tpg_0_1_tpgPatternTartanCEe0_rom is 
...
entity design_1_v_tpg_0_1_tpgPatternTartanCEe0 is
    generic (
        DataWidth : INTEGER := 3;
...
architecture arch of design_1_v_tpg_0_1_tpgPatternTartanCEe0 is
    component design_1_v_tpg_0_1_tpgPatternTartanCEe0_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    design_1_v_tpg_0_1_tpgPatternTartanCEe0_rom_U :  component design_1_v_tpg_0_1_tpgPatternTartanCEe0_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
