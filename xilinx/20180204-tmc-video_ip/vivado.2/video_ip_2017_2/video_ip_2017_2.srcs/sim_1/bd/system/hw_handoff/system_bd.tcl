...
CONFIG.RESET_POLARITY {ACTIVE_LOW} \
  ...
  connect_bd_net -net sim_clk_gen_0_clk [get_bd_ports clk] [get_bd_pins sim_clk_gen_0/clk]
  connect_bd_net -net sim_clk_gen_0_sync_rst [get_bd_ports sync_rst] [get_bd_pins sim_clk_gen_0/sync_rst]
