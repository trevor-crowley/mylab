...
reg   [0:0] ap_reg_pp0_iter1_brmerge_reg_713;
...
wire   [0:0] tmp_60_fu_375_p2;
wire   [0:0] tmp_73_fu_412_p2;
wire   [2:0] tmp_76_fu_430_p2;
wire   [63:0] tmp_77_fu_487_p1;
wire   [63:0] tmp_78_fu_540_p1;
wire   [5:0] tmp_57_fu_357_p2;
wire   [9:0] tmp_75_fu_418_p2;
wire   [9:0] tmp_74_fu_443_p2;
wire   [15:0] tmp_fu_304_p2;
wire   [0:0] tmp_55_fu_326_p2;
wire   [3:0] tmp_47_fu_467_p3;
wire   [7:0] tmp_47_cast_fu_475_p1;
wire   [10:0] tmp_49_fu_479_p3;
wire   [0:0] tmp_83_fu_399_p1;
wire   [0:0] tmp_65_fu_393_p2;
wire   [0:0] tmp_66_cast_not_fu_492_p2;
wire   [7:0] tmp_31_fu_504_p2;
wire   [0:0] tmp_62_fu_381_p2;
wire   [0:0] sel_tmp2_fu_516_p2;
wire   [0:0] tmp_64_fu_387_p2;
wire   [0:0] sel_tmp5_fu_528_p2;
wire   [7:0] DPtpgBarSelRgb_VESA_10_fu_564_p3;
wire   [7:0] val_assign_1_fu_599_p3;
wire  signed [7:0] DPtpgBarSelRgb_CEA_g_4_fu_584_p1;
wire   [7:0] sel_tmp1_fu_606_p3;
wire   [7:0] val_assign_s_fu_592_p3;
wire   [7:0] sel_tmp4_fu_613_p3;
wire  signed [7:0] DPtpgBarSelRgb_CEA_r_4_fu_580_p1;
wire   [7:0] DPtpgBarSelRgb_VESA_7_fu_556_p3;
wire   [0:0] or_cond_fu_634_p2;
wire   [7:0] newSel_fu_627_p3;
wire   [7:0] newSel1_fu_638_p3;
wire  signed [7:0] DPtpgBarSelRgb_CEA_b_4_fu_588_p1;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_52)) begin
        if ((tmp_60_fu_375_p2 == 1'd1)) begin
            hBarSel_5_0 <= 3'd0;
        end else if (((tmp_73_fu_412_p2 == 1'd0) & (tmp_60_fu_375_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_52)) begin
        if ((tmp_60_fu_375_p2 == 1'd1)) begin
            xCount_V_2_0 <= 10'd0;
        end else if (((tmp_60_fu_375_p2 == 1'd0) & (tmp_73_fu_412_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_s_fu_310_p2 == 1'd0) & (1'b1 == ap_ce) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (or_cond_31_fu_338_p2 == 1'd1))) begin
        yCount_V_4 <= tmp_57_fu_357_p2;
    end else if ((((or_cond_31_fu_338_p2 == 1'd0) & (tmp_s_fu_310_p2 == 1'd0) & (1'b1 == ap_ce) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_56_fu_332_p2 == 1'd1)) | ((1'b1 == ap_ce) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_s_fu_310_p2 == 1'd1)))) begin
        yCount_V_4 <= 6'd0;
    end
end
...
always @ (*) begin
    if (((or_cond_31_fu_338_p2 == 1'd0) & (tmp_s_fu_310_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_56_fu_332_p2 == 1'd1))) begin
        ap_phi_mux_vBarSel_3_loc_2_phi_fu_275_p8 = tmp_59_fu_344_p2;
    end else if ((((tmp_56_fu_332_p2 == 1'd0) & (or_cond_31_fu_338_p2 == 1'd0) & (tmp_s_fu_310_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((tmp_s_fu_310_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (or_cond_31_fu_338_p2 == 1'd1)))) begin
        ap_phi_mux_vBarSel_3_loc_2_phi_fu_275_p8 = vBarSel_1;
    end else if (((1'b0 == ap_block_pp0_stage0) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_s_fu_310_p2 == 1'd1))) begin
...
assign DPtpgBarSelRgb_CEA_b_4_fu_588_p1 = $signed(DPtpgBarSelRgb_CEA_b_q0);

assign DPtpgBarSelRgb_CEA_b_address0 = tmp_78_fu_540_p1;

assign DPtpgBarSelRgb_CEA_g_4_fu_584_p1 = $signed(DPtpgBarSelRgb_CEA_g_q0);

assign DPtpgBarSelRgb_CEA_g_address0 = tmp_78_fu_540_p1;

assign DPtpgBarSelRgb_CEA_r_4_fu_580_p1 = $signed(DPtpgBarSelRgb_CEA_r_q0);

assign DPtpgBarSelRgb_CEA_r_address0 = tmp_78_fu_540_p1;

assign DPtpgBarSelRgb_VESA_10_fu_564_p3 = ((DPtpgBarSelRgb_VESA_4_q0[0:0] === 1'b1) ? 8'd255 : 8'd0);
...
assign DPtpgBarSelRgb_VESA_7_fu_556_p3 = ((DPtpgBarSelRgb_VESA_5_q0[0:0] === 1'b1) ? 8'd255 : 8'd0);
...
always @ (*) begin
    ap_condition_255 = ((or_cond_31_fu_338_p2 == 1'd0) & (tmp_s_fu_310_p2 == 1'd0) & (tmp_56_fu_332_p2 == 1'd1));
end
...
assign brmerge_fu_498_p2 = (tmp_66_cast_not_fu_492_p2 | tmp_65_fu_393_p2);

assign newSel1_fu_638_p3 = ((tmp_32_fu_510_p2[0:0] === 1'b1) ? DPtpgBarSelRgb_VESA_7_fu_556_p3 : DPtpgBarSelYuv_709_y_q0);

assign newSel3_fu_653_p3 = ((sel_tmp6_fu_534_p2[0:0] === 1'b1) ? DPtpgBarSelYuv_601_v_q0 : DPtpgBarSelRgb_CEA_b_4_fu_588_p1);

assign newSel4_fu_660_p3 = ((tmp_32_fu_510_p2[0:0] === 1'b1) ? DPtpgBarSelRgb_VESA_2_fu_572_p3 : DPtpgBarSelYuv_709_v_q0);

assign newSel_fu_627_p3 = ((sel_tmp6_fu_534_p2[0:0] === 1'b1) ? DPtpgBarSelYuv_601_y_q0 : DPtpgBarSelRgb_CEA_r_4_fu_580_p1);
...
assign sel_tmp1_fu_606_p3 = ((tmp_32_fu_510_p2[0:0] === 1'b1) ? DPtpgBarSelRgb_VESA_10_fu_564_p3 : val_assign_1_fu_599_p3);

assign sel_tmp2_fu_516_p2 = ((dpDynamicRange != 8'd0) ? 1'b1 : 1'b0);

assign sel_tmp3_fu_522_p2 = (tmp_62_fu_381_p2 & sel_tmp2_fu_516_p2);

assign sel_tmp4_fu_613_p3 = ((sel_tmp3_fu_522_p2[0:0] === 1'b1) ? DPtpgBarSelRgb_CEA_g_4_fu_584_p1 : sel_tmp1_fu_606_p3);

assign sel_tmp5_fu_528_p2 = (tmp_62_fu_381_p2 ^ 1'd1);

assign sel_tmp6_fu_534_p2 = (tmp_64_fu_387_p2 & sel_tmp5_fu_528_p2);

assign tmp_31_fu_504_p2 = (dpDynamicRange | color);

assign tmp_32_fu_510_p2 = ((tmp_31_fu_504_p2 == 8'd0) ? 1'b1 : 1'b0);

assign tmp_47_cast_fu_475_p1 = tmp_47_fu_467_p3;

assign tmp_47_fu_467_p3 = {{ap_phi_mux_vBarSel_3_loc_2_phi_fu_275_p8}, {ap_phi_mux_hBarSel_5_0_loc_phi_fu_289_p6}};

assign tmp_49_fu_479_p3 = {{3'd0}, {tmp_47_cast_fu_475_p1}};

assign tmp_55_fu_326_p2 = ((yCount_V_4 != 6'd63) ? 1'b1 : 1'b0);

assign tmp_56_fu_332_p2 = ((x == 16'd0) ? 1'b1 : 1'b0);

assign tmp_57_fu_357_p2 = (yCount_V_4 + 6'd1);

assign tmp_59_fu_344_p2 = (vBarSel_1 ^ 1'd1);

assign tmp_60_fu_375_p2 = ((x == 16'd0) ? 1'b1 : 1'b0);

assign tmp_62_fu_381_p2 = ((color == 8'd0) ? 1'b1 : 1'b0);

assign tmp_64_fu_387_p2 = ((dpYUVCoef == 8'd0) ? 1'b1 : 1'b0);

assign tmp_65_fu_393_p2 = ((color == 8'd1) ? 1'b1 : 1'b0);

assign tmp_66_cast_not_fu_492_p2 = (tmp_83_fu_399_p1 ^ 1'd1);
...
assign tmp_77_fu_487_p1 = tmp_49_fu_479_p3;

assign tmp_78_fu_540_p1 = DPtpgBarArray_q0;

assign tmp_83_fu_399_p1 = x[0:0];

assign tmp_fu_304_p2 = (y | x);

assign tmp_s_fu_310_p2 = ((tmp_fu_304_p2 == 16'd0) ? 1'b1 : 1'b0);

assign val_assign_1_fu_599_p3 = ((ap_reg_pp0_iter1_brmerge_reg_713[0:0] === 1'b1) ? DPtpgBarSelYuv_709_u_q0 : DPtpgBarSelYuv_709_v_q0);

assign val_assign_s_fu_592_p3 = ((ap_reg_pp0_iter1_brmerge_reg_713[0:0] === 1'b1) ? DPtpgBarSelYuv_601_u_q0 : DPtpgBarSelYuv_601_v_q0);
