...
module ex_sim_v_tpg_1_0_AXIvideo2MultiPixStr (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] exitcond7_reg_538;
reg   [0:0] brmerge_reg_547;
...
reg   [0:0] ap_reg_pp1_iter1_exitcond7_reg_538;
...
reg   [7:0] pix_val_0_V_reg_551;
wire   [7:0] pix_val_1_V_2_fu_436_p1;
reg   [7:0] pix_val_1_V_2_reg_557;
reg   [7:0] pix_val_2_V_reg_563;
...
ex_sim_v_tpg_1_0_reg_unsigned_short_s grp_reg_unsigned_short_s_fu_343(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
ex_sim_v_tpg_1_0_reg_unsigned_short_s grp_reg_unsigned_short_s_fu_349(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (ap_reg_pp1_iter1_exitcond7_reg_538 == 1'd0) & (ap_enable_reg_pp1_iter2 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_683)) begin
        if (((brmerge_reg_547 == 1'd1) & (exitcond7_reg_538 == 1'd0))) begin
            axi_last_V_2_reg_273 <= ap_phi_mux_eol_1_phi_fu_254_p4;
        end else if (((brmerge_reg_547 == 1'd0) & (exitcond7_reg_538 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (exitcond7_reg_538 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (exitcond7_reg_538 == 1'd0) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        pix_val_0_V_reg_551 <= {{ap_phi_mux_p_Val2_s_phi_fu_290_p4[23:16]}};
        pix_val_1_V_2_reg_557 <= pix_val_1_V_2_fu_436_p1;
        pix_val_2_V_reg_563 <= {{ap_phi_mux_p_Val2_s_phi_fu_290_p4[15:8]}};
    end
end
...
always @ (*) begin
    if (((ap_reg_pp1_iter1_exitcond7_reg_538 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter2 == 1'b1))) begin
...
always @ (*) begin
    if (((exitcond7_reg_538 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) | ((eol_2_reg_298 == 1'd0) & (1'b0 == ap_block_pp2_stage0) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0)) | ((brmerge_reg_547 == 1'd0) & (exitcond7_reg_538 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0)))) begin
...
always @ (*) begin
    ap_block_pp1_stage0_01001 = (((ap_reg_pp1_iter1_exitcond7_reg_538 == 1'd0) & (img_V_val_0_V1_status == 1'b0) & (ap_enable_reg_pp1_iter2 == 1'b1)) | ((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op71_read_state7 == 1'b1) & (ap_enable_reg_pp1_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp1_stage0_11001 = (((ap_reg_pp1_iter1_exitcond7_reg_538 == 1'd0) & (img_V_val_0_V1_status == 1'b0) & (ap_enable_reg_pp1_iter2 == 1'b1)) | ((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op71_read_state7 == 1'b1) & (ap_enable_reg_pp1_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp1_stage0_subdone = (((ap_reg_pp1_iter1_exitcond7_reg_538 == 1'd0) & (img_V_val_0_V1_status == 1'b0) & (ap_enable_reg_pp1_iter2 == 1'b1)) | ((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op71_read_state7 == 1'b1) & (ap_enable_reg_pp1_iter1 == 1'b1)));
end
...
always @ (*) begin
    ap_block_state8_pp1_stage0_iter2 = ((ap_reg_pp1_iter1_exitcond7_reg_538 == 1'd0) & (img_V_val_0_V1_status == 1'b0));
end
...
always @ (*) begin
    ap_condition_685 = ((exitcond7_reg_538 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0));
end
...
always @ (*) begin
    ap_predicate_op71_read_state7 = ((brmerge_reg_547 == 1'd0) & (exitcond7_reg_538 == 1'd0));
end

assign brmerge_fu_415_p2 = (sof_1_fu_138 | ap_phi_mux_eol_phi_fu_232_p4);

assign exitcond6_fu_386_p2 = ((i_cast_fu_382_p1 == tmp_141_reg_517) ? 1'b1 : 1'b0);

assign exitcond7_fu_401_p2 = ((j_cast_fu_397_p1 == tmp_140_reg_488) ? 1'b1 : 1'b0);
...
assign img_V_val_0_V_din = ((sel_tmp2_fu_372_p2[0:0] === 1'b1) ? pix_val_0_V_reg_551 : pix_val_1_V_2_reg_557);

assign img_V_val_0_V_write = img_V_val_0_V1_update;

assign img_V_val_1_V_din = ((sel_tmp2_fu_372_p2[0:0] === 1'b1) ? pix_val_1_V_2_reg_557 : pix_val_2_V_reg_563);

assign img_V_val_1_V_write = img_V_val_0_V1_update;

assign img_V_val_2_V_din = ((sel_tmp2_fu_372_p2[0:0] === 1'b1) ? pix_val_2_V_reg_563 : pix_val_0_V_reg_551);
...
assign tmp_141_fu_369_p1 = tmp_reg_483[12:0];

assign tmp_user_V_fu_365_p1 = AXI_video_strm_V_user_V_0_data_out;

endmodule //ex_sim_v_tpg_1_0_AXIvideo2MultiPixStr
