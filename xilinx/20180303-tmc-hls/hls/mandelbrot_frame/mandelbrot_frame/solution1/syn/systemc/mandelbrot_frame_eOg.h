...
#ifndef __mandelbrot_frame_eOg__HH__
#define __mandelbrot_frame_eOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(mandelbrot_frame_eOg) {
    ...
    SC_CTOR(mandelbrot_frame_eOg):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
