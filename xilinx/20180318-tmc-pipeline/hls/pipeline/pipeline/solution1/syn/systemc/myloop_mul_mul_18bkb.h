...
#ifndef __myloop_mul_mul_18bkb__HH__
#define __myloop_mul_mul_18bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myloop_mul_mul_18bkb) {
    ...
    SC_CTOR(myloop_mul_mul_18bkb):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
