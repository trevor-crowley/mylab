...
wire   [13:0] tmp_140_fu_355_p1;
reg   [13:0] tmp_140_reg_491;
wire   [0:0] tmp_129_fu_359_p2;
reg   [23:0] tmp_data_V_reg_500;
reg   [0:0] tmp_last_V_reg_508;
wire   [12:0] tmp_141_fu_369_p1;
reg   [12:0] tmp_141_reg_520;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state5) & ((exitcond6_fu_386_p2 == 1'd1) | (tmp_129_fu_359_p2 == 1'd1)))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp1_stage0_subdone) & (exitcond7_fu_401_p2 == 1'd1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
            ap_enable_reg_pp1_iter0 <= 1'b0;
        end else if (((exitcond6_fu_386_p2 == 1'd0) & (tmp_129_fu_359_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        end else if ((((1'b0 == ap_block_pp1_stage0_subdone) & (1'b1 == ap_condition_pp1_exit_iter1_state7)) | ((exitcond6_fu_386_p2 == 1'd0) & (tmp_129_fu_359_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5)))) begin
            ap_enable_reg_pp1_iter1 <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((tmp_129_fu_359_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state2_on_subcall_done) & (1'b1 == ap_CS_fsm_state2))) begin
        tmp_140_reg_491 <= tmp_140_fu_355_p1;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        tmp_141_reg_520 <= tmp_141_fu_369_p1;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state5) & ((exitcond6_fu_386_p2 == 1'd1) | (tmp_129_fu_359_p2 == 1'd1)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((1'b0 == ap_block_state2_on_subcall_done) & (tmp_129_fu_359_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
                ap_NS_fsm = ap_ST_fsm_state3;
            end else if (((1'b0 == ap_block_state2_on_subcall_done) & (tmp_129_fu_359_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
...
assign exitcond6_fu_386_p2 = ((i_cast_fu_382_p1 == tmp_141_reg_520) ? 1'b1 : 1'b0);

assign exitcond7_fu_401_p2 = ((j_cast_fu_397_p1 == tmp_140_reg_491) ? 1'b1 : 1'b0);
...
assign tmp_129_fu_359_p2 = ((enableInput == 8'd0) ? 1'b1 : 1'b0);

assign tmp_140_fu_355_p1 = grp_reg_unsigned_short_s_fu_349_ap_return[13:0];

assign tmp_141_fu_369_p1 = tmp_reg_486[12:0];
