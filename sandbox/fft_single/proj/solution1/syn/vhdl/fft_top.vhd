...
architecture behav of fft_top is 
    ...
    "fft_top,hls_ip_2020_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7k160t-fbg484-1,HLS_INPUT_CLOCK=3.300000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=2.887500,HLS_SYN_LAT=3195,HLS_SYN_TPT=3196,HLS_SYN_MEM=3,HLS_SYN_DSP=12,HLS_SYN_FF=9932,HLS_SYN_LUT=8216,HLS_VERSION=2020_1}";
