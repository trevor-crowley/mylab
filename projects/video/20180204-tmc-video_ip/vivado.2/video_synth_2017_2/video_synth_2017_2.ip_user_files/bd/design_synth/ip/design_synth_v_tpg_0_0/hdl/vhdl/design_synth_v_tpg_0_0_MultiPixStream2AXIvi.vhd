...
entity design_synth_v_tpg_0_0_MultiPixStream2AXIvi is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of design_synth_v_tpg_0_0_MultiPixStream2AXIvi is 
    ...
    signal ap_reg_pp0_iter1_exitcond2_reg_396 : STD_LOGIC_VECTOR (0 downto 0);
    signal j_reg_178 : STD_LOGIC_VECTOR (12 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal tmp_70_fu_210_p1 : STD_LOGIC_VECTOR (13 downto 0);
    signal tmp_70_reg_365 : STD_LOGIC_VECTOR (13 downto 0);
    ...
    signal tmp_71_fu_214_p1 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_71_reg_370 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_57_cast_fu_224_p1 : STD_LOGIC_VECTOR (13 downto 0);
    signal tmp_57_cast_reg_375 : STD_LOGIC_VECTOR (13 downto 0);
    ...
    signal tmp_69_fu_206_p1 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_56_fu_218_p2 : STD_LOGIC_VECTOR (12 downto 0);
    ...
    signal tmp_6_fu_315_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_5_fu_308_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal axi_0_2_fu_301_p3 : STD_LOGIC_VECTOR (23 downto 0);
    signal tmp_7_fu_322_p3 : STD_LOGIC_VECTOR (15 downto 0);
    signal ap_NS_fsm : STD_LOGIC_VECTOR (4 downto 0);
    signal ap_idle_pp0 : STD_LOGIC;
    signal ap_enable_pp0 : STD_LOGIC;

    component design_synth_v_tpg_0_0_reg_unsigned_short_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    grp_reg_unsigned_short_s_fu_189 : component design_synth_v_tpg_0_0_reg_unsigned_short_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_reg_unsigned_short_s_fu_195 : component design_synth_v_tpg_0_0_reg_unsigned_short_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_const_logic_1 = ap_continue)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state3) and not(((ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_keep_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_strb_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_user_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_last_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_id_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_dest_V_1_ack_in))) and (ap_const_lv1_1 = exitcond1_fu_238_p2))) then 
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_block_pp0_stage0_flag00011011 = ap_const_boolean_0) and (ap_const_logic_1 = ap_condition_pp0_exit_iter0_state4))) then 
                    ap_enable_reg_pp0_iter0 <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state3) and not(((ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_keep_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_strb_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_user_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_last_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_id_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_dest_V_1_ack_in))) and (ap_const_lv1_0 = exitcond1_fu_238_p2))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state3) and not(((ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_keep_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_strb_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_user_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_last_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_id_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_dest_V_1_ack_in))) and (ap_const_lv1_0 = exitcond1_fu_238_p2))) then 
                j_reg_178 <= ap_const_lv13_0;
            elsif (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter0) and (ap_const_lv1_0 = exitcond2_fu_253_p2))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_const_lv1_0 = exitcond2_reg_396) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then
                ap_reg_pp0_iter1_exitcond2_reg_396 <= exitcond2_reg_396;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0) and (ap_const_lv1_0 = exitcond2_fu_253_p2))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state3) and not(((ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_keep_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_strb_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_user_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_last_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_id_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_dest_V_1_ack_in))))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (ap_block_state2_on_subcall_done = ap_const_boolean_0))) then
                tmp_57_cast_reg_375 <= tmp_57_cast_fu_224_p1;
                tmp_70_reg_365 <= tmp_70_fu_210_p1;
                tmp_71_reg_370 <= tmp_71_fu_214_p1;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, AXI_video_strm_V_data_V_1_ack_in, AXI_video_strm_V_keep_V_1_ack_in, AXI_video_strm_V_strb_V_1_ack_in, AXI_video_strm_V_user_V_1_ack_in, AXI_video_strm_V_last_V_1_ack_in, AXI_video_strm_V_id_V_1_ack_in, AXI_video_strm_V_dest_V_1_ack_in, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, ap_CS_fsm_state2, ap_block_state2_on_subcall_done, exitcond1_fu_238_p2, ap_CS_fsm_state3, exitcond2_fu_253_p2, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_flag00011011)
    begin
        case ap_CS_fsm is
    ...
    AXI_video_strm_V_data_V_1_vld_in_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, exitcond2_reg_396, ap_block_pp0_stage0_flag00011001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_const_lv1_0 = exitcond2_reg_396) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then 
    ...
    AXI_video_strm_V_dest_V_1_vld_in_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, exitcond2_reg_396, ap_block_pp0_stage0_flag00011001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_const_lv1_0 = exitcond2_reg_396) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then 
    ...
    AXI_video_strm_V_id_V_1_vld_in_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, exitcond2_reg_396, ap_block_pp0_stage0_flag00011001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_const_lv1_0 = exitcond2_reg_396) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then 
    ...
    AXI_video_strm_V_keep_V_1_vld_in_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, exitcond2_reg_396, ap_block_pp0_stage0_flag00011001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_const_lv1_0 = exitcond2_reg_396) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then 
    ...
    AXI_video_strm_V_last_V_1_vld_in_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, exitcond2_reg_396, ap_block_pp0_stage0_flag00011001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_const_lv1_0 = exitcond2_reg_396) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then 
    ...
    AXI_video_strm_V_strb_V_1_vld_in_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, exitcond2_reg_396, ap_block_pp0_stage0_flag00011001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_const_lv1_0 = exitcond2_reg_396) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then 
    ...
    AXI_video_strm_V_user_V_1_vld_in_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, exitcond2_reg_396, ap_block_pp0_stage0_flag00011001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_const_lv1_0 = exitcond2_reg_396) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then 
    ...
    ap_block_pp0_stage0_flag00001001_assign_proc : process(ap_enable_reg_pp0_iter1, exitcond2_reg_396, strmPix_V_val_0_V0_status)
    begin
                ap_block_pp0_stage0_flag00001001 <= ((ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_const_lv1_0 = exitcond2_reg_396) and (ap_const_logic_0 = strmPix_V_val_0_V0_status));
    end process;


    ap_block_pp0_stage0_flag00011001_assign_proc : process(ap_enable_reg_pp0_iter1, exitcond2_reg_396, ap_enable_reg_pp0_iter2, strmPix_V_val_0_V0_status, ap_block_state5_io, ap_block_state6_io)
    begin
                ap_block_pp0_stage0_flag00011001 <= (((ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (((ap_const_lv1_0 = exitcond2_reg_396) and (ap_const_logic_0 = strmPix_V_val_0_V0_status)) or (ap_const_boolean_1 = ap_block_state5_io))) or ((ap_const_logic_1 = ap_enable_reg_pp0_iter2) and (ap_const_boolean_1 = ap_block_state6_io)));
    end process;


    ap_block_pp0_stage0_flag00011011_assign_proc : process(ap_enable_reg_pp0_iter1, exitcond2_reg_396, ap_enable_reg_pp0_iter2, strmPix_V_val_0_V0_status, ap_block_state5_io, ap_block_state6_io)
    begin
                ap_block_pp0_stage0_flag00011011 <= (((ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (((ap_const_lv1_0 = exitcond2_reg_396) and (ap_const_logic_0 = strmPix_V_val_0_V0_status)) or (ap_const_boolean_1 = ap_block_state5_io))) or ((ap_const_logic_1 = ap_enable_reg_pp0_iter2) and (ap_const_boolean_1 = ap_block_state6_io)));
    end process;
    ...
    ap_block_state2_on_subcall_done_assign_proc : process(grp_reg_unsigned_short_s_fu_189_ap_done, grp_reg_unsigned_short_s_fu_195_ap_done)
    begin
                ap_block_state2_on_subcall_done <= ((ap_const_logic_0 = grp_reg_unsigned_short_s_fu_189_ap_done) or (ap_const_logic_0 = grp_reg_unsigned_short_s_fu_195_ap_done));
    end process;
    ...
    ap_block_state5_pp0_stage0_iter1_assign_proc : process(exitcond2_reg_396, strmPix_V_val_0_V0_status)
    begin
                ap_block_state5_pp0_stage0_iter1 <= ((ap_const_lv1_0 = exitcond2_reg_396) and (ap_const_logic_0 = strmPix_V_val_0_V0_status));
    end process;


    ap_block_state6_io_assign_proc : process(AXI_video_strm_V_data_V_1_ack_in, ap_reg_pp0_iter1_exitcond2_reg_396)
    begin
                ap_block_state6_io <= ((ap_const_lv1_0 = ap_reg_pp0_iter1_exitcond2_reg_396) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in));
    end process;

        ap_block_state6_pp0_stage0_iter2 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_condition_pp0_exit_iter0_state4_assign_proc : process(exitcond2_fu_253_p2)
    begin
        if ((ap_const_lv1_1 = exitcond2_fu_253_p2)) then 
    ...
    ap_ready_assign_proc : process(AXI_video_strm_V_data_V_1_ack_in, AXI_video_strm_V_keep_V_1_ack_in, AXI_video_strm_V_strb_V_1_ack_in, AXI_video_strm_V_user_V_1_ack_in, AXI_video_strm_V_last_V_1_ack_in, AXI_video_strm_V_id_V_1_ack_in, AXI_video_strm_V_dest_V_1_ack_in, exitcond1_fu_238_p2, ap_CS_fsm_state3)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state3) and not(((ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_keep_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_strb_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_user_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_last_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_id_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_dest_V_1_ack_in))) and (ap_const_lv1_1 = exitcond1_fu_238_p2))) then 
    ...
    axi_last_V_fu_264_p2 <= "1" when (j_cast_fu_249_p1 = tmp_57_cast_reg_375) else "0";
    exitcond1_fu_238_p2 <= "1" when (i_cast_fu_234_p1 = tmp_71_reg_370) else "0";
    exitcond2_fu_253_p2 <= "1" when (j_cast_fu_249_p1 = tmp_70_reg_365) else "0";
    ...
    i_cast_fu_234_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_reg_167),13));
    j_1_fu_258_p2 <= std_logic_vector(unsigned(j_reg_178) + unsigned(ap_const_lv13_1));
    j_cast_fu_249_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(j_reg_178),14));
    m_axis_video_TDATA <= AXI_video_strm_V_data_V_1_data_out;

    m_axis_video_TDATA_blk_n_assign_proc : process(AXI_video_strm_V_data_V_1_state, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_flag00000000, exitcond2_reg_396, ap_enable_reg_pp0_iter2, ap_reg_pp0_iter1_exitcond2_reg_396)
    begin
        if ((((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_block_pp0_stage0_flag00000000 = ap_const_boolean_0) and (ap_const_lv1_0 = exitcond2_reg_396)) or ((ap_block_pp0_stage0_flag00000000 = ap_const_boolean_0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter2) and (ap_const_lv1_0 = ap_reg_pp0_iter1_exitcond2_reg_396)))) then 
    ...
    strmPix_V_val_0_V0_update_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, exitcond2_reg_396, ap_block_pp0_stage0_flag00011001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_const_lv1_0 = exitcond2_reg_396) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then 
    ...
    strmPix_V_val_0_V_blk_n_assign_proc : process(strmPix_V_val_0_V_empty_n, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_flag00000000, exitcond2_reg_396)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_block_pp0_stage0_flag00000000 = ap_const_boolean_0) and (ap_const_lv1_0 = exitcond2_reg_396))) then 
    ...
    strmPix_V_val_1_V_blk_n_assign_proc : process(strmPix_V_val_1_V_empty_n, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_flag00000000, exitcond2_reg_396)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_block_pp0_stage0_flag00000000 = ap_const_boolean_0) and (ap_const_lv1_0 = exitcond2_reg_396))) then 
    ...
    strmPix_V_val_2_V_blk_n_assign_proc : process(strmPix_V_val_2_V_empty_n, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_flag00000000, exitcond2_reg_396)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_block_pp0_stage0_flag00000000 = ap_const_boolean_0) and (ap_const_lv1_0 = exitcond2_reg_396))) then 
    ...
    tmp_56_fu_218_p2 <= std_logic_vector(signed(ap_const_lv13_1FFF) + signed(tmp_69_fu_206_p1));
        tmp_57_cast_fu_224_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_56_fu_218_p2),14));

    tmp_5_fu_308_p3 <= 
        strmPix_V_val_2_V_dout when (sel_tmp2_fu_228_p2(0) = '1') else 
        strmPix_V_val_1_V_dout;
    tmp_69_fu_206_p1 <= grp_reg_unsigned_short_s_fu_195_ap_return(13 - 1 downto 0);
    tmp_6_fu_315_p3 <= 
        strmPix_V_val_0_V_dout when (sel_tmp2_fu_228_p2(0) = '1') else 
        strmPix_V_val_2_V_dout;
    tmp_70_fu_210_p1 <= grp_reg_unsigned_short_s_fu_195_ap_return(14 - 1 downto 0);
    tmp_71_fu_214_p1 <= grp_reg_unsigned_short_s_fu_189_ap_return(13 - 1 downto 0);
    tmp_7_fu_322_p3 <= (tmp_6_fu_315_p3 & tmp_5_fu_308_p3);
    tmp_data_V_fu_330_p5 <= (tmp_7_fu_322_p3 & axi_0_2_fu_301_p3(7 downto 0));
end behav;
