...
#ifndef __myloop_mul_mul_18cud__HH__
#define __myloop_mul_mul_18cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myloop_mul_mul_18cud) {
    ...
    SC_CTOR(myloop_mul_mul_18cud):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
