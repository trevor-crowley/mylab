...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net axi_vip_0_M_AXI [get_bd_intf_pins axi_vip_0/M_AXI] [get_bd_intf_pins video_mandelbrot_gen_0/s_axi_cmd]
  ...
  connect_bd_net -net aclk_40MHz_1 [get_bd_ports aclk_40MHz] [get_bd_pins axi_vip_0/aclk] [get_bd_pins video_mandelbrot_gen_0/ap_clk]
  connect_bd_net -net aresetn_0_1 [get_bd_ports aresetn_0] [get_bd_pins axi_vip_0/aresetn] [get_bd_pins video_mandelbrot_gen_0/ap_rst_n]
