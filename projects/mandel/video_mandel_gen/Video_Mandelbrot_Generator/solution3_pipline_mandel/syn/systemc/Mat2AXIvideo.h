...
struct Mat2AXIvideo : public sc_module {
    ...
    sc_signal< sc_lv<4> > t_V_1_reg_188;
    sc_signal< sc_lv<1> > icmp_ln125_fu_204_p2;
    sc_signal< sc_logic > ap_CS_fsm_state2;
    sc_signal< bool > ap_block_state2;
    sc_signal< sc_lv<3> > i_V_fu_210_p2;
    sc_signal< sc_lv<3> > i_V_reg_265;
    ...
    sc_signal< sc_lv<4> > j_V_fu_222_p2;
