...
struct dataflow_parent_loop_1 : public sc_module {
    ...
    sc_signal< sc_lv<8> > dataflow_in_loop_out_U0_img_0_data_stream_0_V_din;
    sc_signal< sc_logic > dataflow_in_loop_out_U0_img_0_data_stream_0_V_write;
    sc_signal< sc_lv<8> > dataflow_in_loop_out_U0_img_0_data_stream_1_V_din;
    sc_signal< sc_logic > dataflow_in_loop_out_U0_img_0_data_stream_1_V_write;
    sc_signal< sc_lv<8> > dataflow_in_loop_out_U0_img_0_data_stream_2_V_din;
    sc_signal< sc_logic > dataflow_in_loop_out_U0_img_0_data_stream_2_V_write;
