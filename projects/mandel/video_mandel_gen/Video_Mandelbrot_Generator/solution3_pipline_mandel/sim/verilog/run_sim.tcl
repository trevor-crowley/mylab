...
if {[file isfile video_mandelbrot_generator.autotvin.dat]} {
	file delete -force video_mandelbrot_generator.autotvin.dat
}

if {[file isfile video_mandelbrot_generator.autotvout.dat]} {
	file delete -force video_mandelbrot_generator.autotvout.dat
}
