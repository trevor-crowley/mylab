...
struct video_mandelbrot_generator : public sc_module {
    ...
    sc_signal< sc_logic > Loop_out_proc24_U0_ap_start;
    sc_signal< sc_logic > Loop_out_proc24_U0_ap_done;
    sc_signal< sc_logic > Loop_out_proc24_U0_ap_continue;
    sc_signal< sc_logic > Loop_out_proc24_U0_ap_idle;
    sc_signal< sc_logic > Loop_out_proc24_U0_ap_ready;
    sc_signal< sc_logic > Loop_out_proc24_U0_start_out;
    sc_signal< sc_logic > Loop_out_proc24_U0_start_write;
    sc_signal< sc_lv<8> > Loop_out_proc24_U0_img_0_data_stream_0_V_din;
    sc_signal< sc_logic > Loop_out_proc24_U0_img_0_data_stream_0_V_write;
    sc_signal< sc_lv<8> > Loop_out_proc24_U0_img_0_data_stream_1_V_din;
    sc_signal< sc_logic > Loop_out_proc24_U0_img_0_data_stream_1_V_write;
    sc_signal< sc_lv<8> > Loop_out_proc24_U0_img_0_data_stream_2_V_din;
    sc_signal< sc_logic > Loop_out_proc24_U0_img_0_data_stream_2_V_write;
    ...
    void thread_Loop_out_proc24_U0_ap_continue();
    void thread_Loop_out_proc24_U0_ap_start();
