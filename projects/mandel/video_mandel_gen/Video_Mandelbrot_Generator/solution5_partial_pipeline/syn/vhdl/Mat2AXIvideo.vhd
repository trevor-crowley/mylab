...
port (
    ...
    img_0_data_stream_V_s_dout : IN STD_LOGIC_VECTOR (7 downto 0);
    img_0_data_stream_V_s_empty_n : IN STD_LOGIC;
    img_0_data_stream_V_s_read : OUT STD_LOGIC;
    img_0_data_stream_V_1_dout : IN STD_LOGIC_VECTOR (7 downto 0);
    img_0_data_stream_V_1_empty_n : IN STD_LOGIC;
    img_0_data_stream_V_1_read : OUT STD_LOGIC;
    img_0_data_stream_V_2_dout : IN STD_LOGIC_VECTOR (7 downto 0);
    img_0_data_stream_V_2_empty_n : IN STD_LOGIC;
    img_0_data_stream_V_2_read : OUT STD_LOGIC );
end;
...
architecture behav of Mat2AXIvideo is 
    ...
    signal img_0_rows_V : STD_LOGIC_VECTOR (31 downto 0) := "00000000000000000000001001011000";
    signal img_0_cols_V : STD_LOGIC_VECTOR (31 downto 0) := "00000000000000000000001100100000";
    ...
    signal t_V_1_reg_156 : STD_LOGIC_VECTOR (9 downto 0);
    signal empty_fu_171_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal empty_reg_256 : STD_LOGIC_VECTOR (9 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal empty_116_fu_179_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal empty_116_reg_261 : STD_LOGIC_VECTOR (9 downto 0);
    signal ret_V_fu_187_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal ret_V_reg_266 : STD_LOGIC_VECTOR (10 downto 0);
    signal icmp_ln125_fu_198_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal ap_block_state2 : BOOLEAN;
    signal i_V_fu_203_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal i_V_reg_275 : STD_LOGIC_VECTOR (9 downto 0);
    signal icmp_ln126_fu_209_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal j_V_fu_214_p2 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal trunc_ln1354_fu_183_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal zext_ln879_fu_220_p1 : STD_LOGIC_VECTOR (10 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                elsif ((((ap_const_lv2_1 = AXI_video_strm_V_data_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_data_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0) and (ap_const_logic_1 = AXI_video_strm_V_data_V_1_vld_in)))) then 
                    AXI_video_strm_V_data_V_1_state <= ap_const_lv2_1;
                elsif (((not(((ap_const_logic_0 = AXI_video_strm_V_data_V_1_vld_in) and (ap_const_logic_1 = AXI_video_strm_V_data_V_1_ack_out))) and not(((m_axis_video_TREADY = ap_const_logic_0) and (ap_const_logic_1 = AXI_video_strm_V_data_V_1_vld_in))) and (ap_const_lv2_3 = AXI_video_strm_V_data_V_1_state)) or ((ap_const_lv2_1 = AXI_video_strm_V_data_V_1_state) and (ap_const_logic_1 = AXI_video_strm_V_data_V_1_ack_out)) or ((ap_const_lv2_2 = AXI_video_strm_V_data_V_1_state) and (ap_const_logic_1 = AXI_video_strm_V_data_V_1_vld_in)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                elsif ((((ap_const_lv2_1 = AXI_video_strm_V_dest_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_dest_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0) and (ap_const_logic_1 = AXI_video_strm_V_dest_V_1_vld_in)))) then 
                    AXI_video_strm_V_dest_V_1_state <= ap_const_lv2_1;
                elsif (((not(((ap_const_logic_0 = AXI_video_strm_V_dest_V_1_vld_in) and (ap_const_logic_1 = AXI_video_strm_V_dest_V_1_ack_out))) and not(((m_axis_video_TREADY = ap_const_logic_0) and (ap_const_logic_1 = AXI_video_strm_V_dest_V_1_vld_in))) and (ap_const_lv2_3 = AXI_video_strm_V_dest_V_1_state)) or ((ap_const_lv2_1 = AXI_video_strm_V_dest_V_1_state) and (ap_const_logic_1 = AXI_video_strm_V_dest_V_1_ack_out)) or ((ap_const_lv2_2 = AXI_video_strm_V_dest_V_1_state) and (ap_const_logic_1 = AXI_video_strm_V_dest_V_1_vld_in)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                elsif ((((ap_const_lv2_1 = AXI_video_strm_V_id_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_id_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0) and (ap_const_logic_1 = AXI_video_strm_V_id_V_1_vld_in)))) then 
                    AXI_video_strm_V_id_V_1_state <= ap_const_lv2_1;
                elsif (((not(((ap_const_logic_0 = AXI_video_strm_V_id_V_1_vld_in) and (ap_const_logic_1 = AXI_video_strm_V_id_V_1_ack_out))) and not(((m_axis_video_TREADY = ap_const_logic_0) and (ap_const_logic_1 = AXI_video_strm_V_id_V_1_vld_in))) and (ap_const_lv2_3 = AXI_video_strm_V_id_V_1_state)) or ((ap_const_lv2_1 = AXI_video_strm_V_id_V_1_state) and (ap_const_logic_1 = AXI_video_strm_V_id_V_1_ack_out)) or ((ap_const_lv2_2 = AXI_video_strm_V_id_V_1_state) and (ap_const_logic_1 = AXI_video_strm_V_id_V_1_vld_in)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_logic_1 = AXI_video_strm_V_keep_V_1_vld_out) and (ap_const_logic_1 = AXI_video_strm_V_keep_V_1_ack_out))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                elsif ((((ap_const_lv2_1 = AXI_video_strm_V_keep_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_keep_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0) and (ap_const_logic_1 = AXI_video_strm_V_keep_V_1_vld_in)))) then 
                    AXI_video_strm_V_keep_V_1_state <= ap_const_lv2_1;
                elsif (((not(((ap_const_logic_0 = AXI_video_strm_V_keep_V_1_vld_in) and (ap_const_logic_1 = AXI_video_strm_V_keep_V_1_ack_out))) and not(((m_axis_video_TREADY = ap_const_logic_0) and (ap_const_logic_1 = AXI_video_strm_V_keep_V_1_vld_in))) and (ap_const_lv2_3 = AXI_video_strm_V_keep_V_1_state)) or ((ap_const_lv2_1 = AXI_video_strm_V_keep_V_1_state) and (ap_const_logic_1 = AXI_video_strm_V_keep_V_1_ack_out)) or ((ap_const_lv2_2 = AXI_video_strm_V_keep_V_1_state) and (ap_const_logic_1 = AXI_video_strm_V_keep_V_1_vld_in)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                elsif ((((ap_const_lv2_1 = AXI_video_strm_V_last_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_last_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0) and (ap_const_logic_1 = AXI_video_strm_V_last_V_1_vld_in)))) then 
                    AXI_video_strm_V_last_V_1_state <= ap_const_lv2_1;
                elsif (((not(((ap_const_logic_0 = AXI_video_strm_V_last_V_1_vld_in) and (ap_const_logic_1 = AXI_video_strm_V_last_V_1_ack_out))) and not(((m_axis_video_TREADY = ap_const_logic_0) and (ap_const_logic_1 = AXI_video_strm_V_last_V_1_vld_in))) and (ap_const_lv2_3 = AXI_video_strm_V_last_V_1_state)) or ((ap_const_lv2_1 = AXI_video_strm_V_last_V_1_state) and (ap_const_logic_1 = AXI_video_strm_V_last_V_1_ack_out)) or ((ap_const_lv2_2 = AXI_video_strm_V_last_V_1_state) and (ap_const_logic_1 = AXI_video_strm_V_last_V_1_vld_in)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                elsif ((((ap_const_lv2_1 = AXI_video_strm_V_strb_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_strb_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0) and (ap_const_logic_1 = AXI_video_strm_V_strb_V_1_vld_in)))) then 
                    AXI_video_strm_V_strb_V_1_state <= ap_const_lv2_1;
                elsif (((not(((ap_const_logic_0 = AXI_video_strm_V_strb_V_1_vld_in) and (ap_const_logic_1 = AXI_video_strm_V_strb_V_1_ack_out))) and not(((m_axis_video_TREADY = ap_const_logic_0) and (ap_const_logic_1 = AXI_video_strm_V_strb_V_1_vld_in))) and (ap_const_lv2_3 = AXI_video_strm_V_strb_V_1_state)) or ((ap_const_lv2_1 = AXI_video_strm_V_strb_V_1_state) and (ap_const_logic_1 = AXI_video_strm_V_strb_V_1_ack_out)) or ((ap_const_lv2_2 = AXI_video_strm_V_strb_V_1_state) and (ap_const_logic_1 = AXI_video_strm_V_strb_V_1_vld_in)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                elsif ((((ap_const_lv2_1 = AXI_video_strm_V_user_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_user_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0) and (ap_const_logic_1 = AXI_video_strm_V_user_V_1_vld_in)))) then 
                    AXI_video_strm_V_user_V_1_state <= ap_const_lv2_1;
                elsif (((not(((ap_const_logic_0 = AXI_video_strm_V_user_V_1_vld_in) and (ap_const_logic_1 = AXI_video_strm_V_user_V_1_ack_out))) and not(((m_axis_video_TREADY = ap_const_logic_0) and (ap_const_logic_1 = AXI_video_strm_V_user_V_1_vld_in))) and (ap_const_lv2_3 = AXI_video_strm_V_user_V_1_state)) or ((ap_const_lv2_1 = AXI_video_strm_V_user_V_1_state) and (ap_const_logic_1 = AXI_video_strm_V_user_V_1_ack_out)) or ((ap_const_lv2_2 = AXI_video_strm_V_user_V_1_state) and (ap_const_logic_1 = AXI_video_strm_V_user_V_1_vld_in)))) then 
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif ((not(((ap_const_lv2_1 = AXI_video_strm_V_dest_V_1_state) or (ap_const_lv2_1 = AXI_video_strm_V_id_V_1_state) or (ap_const_lv2_1 = AXI_video_strm_V_last_V_1_state) or (ap_const_lv2_1 = AXI_video_strm_V_user_V_1_state) or (ap_const_lv2_1 = AXI_video_strm_V_strb_V_1_state) or (ap_const_lv2_1 = AXI_video_strm_V_keep_V_1_state) or (ap_const_lv2_1 = AXI_video_strm_V_data_V_1_state) or ((ap_const_lv2_3 = AXI_video_strm_V_data_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_dest_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_id_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_last_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_user_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_strb_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_keep_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)))) and (icmp_ln125_fu_198_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_const_logic_1 = ap_condition_pp0_exit_iter0_state3) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                    ap_enable_reg_pp0_iter0 <= ap_const_logic_0;
                elsif ((not(((ap_const_lv2_1 = AXI_video_strm_V_dest_V_1_state) or (ap_const_lv2_1 = AXI_video_strm_V_id_V_1_state) or (ap_const_lv2_1 = AXI_video_strm_V_last_V_1_state) or (ap_const_lv2_1 = AXI_video_strm_V_user_V_1_state) or (ap_const_lv2_1 = AXI_video_strm_V_strb_V_1_state) or (ap_const_lv2_1 = AXI_video_strm_V_keep_V_1_state) or (ap_const_lv2_1 = AXI_video_strm_V_data_V_1_state) or ((ap_const_lv2_3 = AXI_video_strm_V_data_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_dest_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_id_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_last_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_user_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_strb_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_keep_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)))) and (icmp_ln125_fu_198_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    img_0_cols_V_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
        end if;
    end process;

    img_0_rows_V_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln126_fu_209_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                t_V_1_reg_156 <= j_V_fu_214_p2;
            elsif ((not(((ap_const_lv2_1 = AXI_video_strm_V_dest_V_1_state) or (ap_const_lv2_1 = AXI_video_strm_V_id_V_1_state) or (ap_const_lv2_1 = AXI_video_strm_V_last_V_1_state) or (ap_const_lv2_1 = AXI_video_strm_V_user_V_1_state) or (ap_const_lv2_1 = AXI_video_strm_V_strb_V_1_state) or (ap_const_lv2_1 = AXI_video_strm_V_keep_V_1_state) or (ap_const_lv2_1 = AXI_video_strm_V_data_V_1_state) or ((ap_const_lv2_3 = AXI_video_strm_V_data_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_dest_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_id_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_last_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_user_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_strb_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_keep_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)))) and (icmp_ln125_fu_198_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
                t_V_1_reg_156 <= ap_const_lv10_0;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln126_reg_280 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln126_fu_209_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                icmp_ln126_reg_280 <= icmp_ln126_fu_209_p2;
                icmp_ln126_reg_280_pp0_iter1_reg <= icmp_ln126_reg_280;
            end if;
        end if;
    end process;
    empty_reg_256(9 downto 0) <= "1001011000";
    empty_116_reg_261(9 downto 0) <= "1100100000";
    ret_V_reg_266(10 downto 0) <= "01100011111";

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, m_axis_video_TREADY, AXI_video_strm_V_data_V_1_state, AXI_video_strm_V_keep_V_1_state, AXI_video_strm_V_strb_V_1_state, AXI_video_strm_V_user_V_1_state, AXI_video_strm_V_last_V_1_state, AXI_video_strm_V_id_V_1_state, AXI_video_strm_V_dest_V_1_state, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, icmp_ln125_fu_198_p2, ap_CS_fsm_state2, icmp_ln126_fu_209_p2, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone)
    begin
        case ap_CS_fsm is
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(img_0_data_stream_V_s_empty_n, img_0_data_stream_V_1_empty_n, img_0_data_stream_V_2_empty_n, ap_enable_reg_pp0_iter1, icmp_ln126_reg_280)
    begin
                ap_block_pp0_stage0_01001 <= ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (((icmp_ln126_reg_280 = ap_const_lv1_0) and (img_0_data_stream_V_2_empty_n = ap_const_logic_0)) or ((icmp_ln126_reg_280 = ap_const_lv1_0) and (img_0_data_stream_V_1_empty_n = ap_const_logic_0)) or ((icmp_ln126_reg_280 = ap_const_lv1_0) and (img_0_data_stream_V_s_empty_n = ap_const_logic_0))));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(img_0_data_stream_V_s_empty_n, img_0_data_stream_V_1_empty_n, img_0_data_stream_V_2_empty_n, ap_enable_reg_pp0_iter1, icmp_ln126_reg_280, ap_enable_reg_pp0_iter2, ap_block_state4_io, ap_block_state5_io)
    begin
                ap_block_pp0_stage0_11001 <= (((ap_const_boolean_1 = ap_block_state5_io) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and ((ap_const_boolean_1 = ap_block_state4_io) or ((icmp_ln126_reg_280 = ap_const_lv1_0) and (img_0_data_stream_V_2_empty_n = ap_const_logic_0)) or ((icmp_ln126_reg_280 = ap_const_lv1_0) and (img_0_data_stream_V_1_empty_n = ap_const_logic_0)) or ((icmp_ln126_reg_280 = ap_const_lv1_0) and (img_0_data_stream_V_s_empty_n = ap_const_logic_0)))));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(img_0_data_stream_V_s_empty_n, img_0_data_stream_V_1_empty_n, img_0_data_stream_V_2_empty_n, ap_enable_reg_pp0_iter1, icmp_ln126_reg_280, ap_enable_reg_pp0_iter2, ap_block_state4_io, ap_block_state5_io)
    begin
    ...
    ap_block_state2_assign_proc : process(m_axis_video_TREADY, AXI_video_strm_V_data_V_1_state, AXI_video_strm_V_keep_V_1_state, AXI_video_strm_V_strb_V_1_state, AXI_video_strm_V_user_V_1_state, AXI_video_strm_V_last_V_1_state, AXI_video_strm_V_id_V_1_state, AXI_video_strm_V_dest_V_1_state)
    begin
                ap_block_state2 <= ((ap_const_lv2_1 = AXI_video_strm_V_dest_V_1_state) or (ap_const_lv2_1 = AXI_video_strm_V_id_V_1_state) or (ap_const_lv2_1 = AXI_video_strm_V_last_V_1_state) or (ap_const_lv2_1 = AXI_video_strm_V_user_V_1_state) or (ap_const_lv2_1 = AXI_video_strm_V_strb_V_1_state) or (ap_const_lv2_1 = AXI_video_strm_V_keep_V_1_state) or (ap_const_lv2_1 = AXI_video_strm_V_data_V_1_state) or ((ap_const_lv2_3 = AXI_video_strm_V_data_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_dest_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_id_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_last_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_user_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_strb_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_keep_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)));
    end process;
    ...
    ap_block_state4_pp0_stage0_iter1_assign_proc : process(img_0_data_stream_V_s_empty_n, img_0_data_stream_V_1_empty_n, img_0_data_stream_V_2_empty_n, icmp_ln126_reg_280)
    begin
                ap_block_state4_pp0_stage0_iter1 <= (((icmp_ln126_reg_280 = ap_const_lv1_0) and (img_0_data_stream_V_2_empty_n = ap_const_logic_0)) or ((icmp_ln126_reg_280 = ap_const_lv1_0) and (img_0_data_stream_V_1_empty_n = ap_const_logic_0)) or ((icmp_ln126_reg_280 = ap_const_lv1_0) and (img_0_data_stream_V_s_empty_n = ap_const_logic_0)));
    end process;
    ...
    ap_condition_pp0_exit_iter0_state3_assign_proc : process(icmp_ln126_fu_209_p2)
    begin
        if ((icmp_ln126_fu_209_p2 = ap_const_lv1_1)) then 
    ...
    ap_done_assign_proc : process(ap_done_reg, m_axis_video_TREADY, AXI_video_strm_V_data_V_1_state, AXI_video_strm_V_keep_V_1_state, AXI_video_strm_V_strb_V_1_state, AXI_video_strm_V_user_V_1_state, AXI_video_strm_V_last_V_1_state, AXI_video_strm_V_id_V_1_state, AXI_video_strm_V_dest_V_1_state, icmp_ln125_fu_198_p2, ap_CS_fsm_state2)
    begin
        if ((not(((ap_const_lv2_1 = AXI_video_strm_V_dest_V_1_state) or (ap_const_lv2_1 = AXI_video_strm_V_id_V_1_state) or (ap_const_lv2_1 = AXI_video_strm_V_last_V_1_state) or (ap_const_lv2_1 = AXI_video_strm_V_user_V_1_state) or (ap_const_lv2_1 = AXI_video_strm_V_strb_V_1_state) or (ap_const_lv2_1 = AXI_video_strm_V_keep_V_1_state) or (ap_const_lv2_1 = AXI_video_strm_V_data_V_1_state) or ((ap_const_lv2_3 = AXI_video_strm_V_data_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_dest_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_id_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_last_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_user_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_strb_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_keep_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)))) and (icmp_ln125_fu_198_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    ap_ready_assign_proc : process(m_axis_video_TREADY, AXI_video_strm_V_data_V_1_state, AXI_video_strm_V_keep_V_1_state, AXI_video_strm_V_strb_V_1_state, AXI_video_strm_V_user_V_1_state, AXI_video_strm_V_last_V_1_state, AXI_video_strm_V_id_V_1_state, AXI_video_strm_V_dest_V_1_state, icmp_ln125_fu_198_p2, ap_CS_fsm_state2)
    begin
        if ((not(((ap_const_lv2_1 = AXI_video_strm_V_dest_V_1_state) or (ap_const_lv2_1 = AXI_video_strm_V_id_V_1_state) or (ap_const_lv2_1 = AXI_video_strm_V_last_V_1_state) or (ap_const_lv2_1 = AXI_video_strm_V_user_V_1_state) or (ap_const_lv2_1 = AXI_video_strm_V_strb_V_1_state) or (ap_const_lv2_1 = AXI_video_strm_V_keep_V_1_state) or (ap_const_lv2_1 = AXI_video_strm_V_data_V_1_state) or ((ap_const_lv2_3 = AXI_video_strm_V_data_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_dest_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_id_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_last_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_user_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_strb_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)) or ((ap_const_lv2_3 = AXI_video_strm_V_keep_V_1_state) and (m_axis_video_TREADY = ap_const_logic_0)))) and (icmp_ln125_fu_198_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    axi_last_V_fu_224_p2 <= "1" when (zext_ln879_fu_220_p1 = ret_V_reg_266) else "0";
    empty_116_fu_179_p1 <= img_0_cols_V(10 - 1 downto 0);
    empty_fu_171_p1 <= img_0_rows_V(10 - 1 downto 0);
    i_V_fu_203_p2 <= std_logic_vector(unsigned(t_V_reg_145) + unsigned(ap_const_lv10_1));
    icmp_ln125_fu_198_p2 <= "1" when (t_V_reg_145 = empty_reg_256) else "0";
    icmp_ln126_fu_209_p2 <= "1" when (t_V_1_reg_156 = empty_116_reg_261) else "0";

    img_0_data_stream_V_1_blk_n_assign_proc : process(img_0_data_stream_V_1_empty_n, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, icmp_ln126_reg_280)
    begin
        if (((icmp_ln126_reg_280 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            img_0_data_stream_V_1_blk_n <= img_0_data_stream_V_1_empty_n;
        else 
    ...
    img_0_data_stream_V_1_read_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln126_reg_280, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln126_reg_280 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            img_0_data_stream_V_1_read <= ap_const_logic_1;
        else 
            img_0_data_stream_V_1_read <= ap_const_logic_0;
        end if; 
    end process;


    img_0_data_stream_V_2_blk_n_assign_proc : process(img_0_data_stream_V_2_empty_n, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, icmp_ln126_reg_280)
    begin
        if (((icmp_ln126_reg_280 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            img_0_data_stream_V_2_blk_n <= img_0_data_stream_V_2_empty_n;
        else 
    ...
    img_0_data_stream_V_2_read_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln126_reg_280, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln126_reg_280 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            img_0_data_stream_V_2_read <= ap_const_logic_1;
        else 
            img_0_data_stream_V_2_read <= ap_const_logic_0;
        end if; 
    end process;


    img_0_data_stream_V_s_blk_n_assign_proc : process(img_0_data_stream_V_s_empty_n, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, icmp_ln126_reg_280)
    begin
        if (((icmp_ln126_reg_280 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            img_0_data_stream_V_s_blk_n <= img_0_data_stream_V_s_empty_n;
        else 
    ...
    img_0_data_stream_V_s_read_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln126_reg_280, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln126_reg_280 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            img_0_data_stream_V_s_read <= ap_const_logic_1;
        else 
            img_0_data_stream_V_s_read <= ap_const_logic_0;
        end if; 
    end process;

    j_V_fu_214_p2 <= std_logic_vector(unsigned(t_V_1_reg_156) + unsigned(ap_const_lv10_1));
    m_axis_video_TDATA <= AXI_video_strm_V_data_V_1_data_out;

    m_axis_video_TDATA_blk_n_assign_proc : process(AXI_video_strm_V_data_V_1_state, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, icmp_ln126_reg_280, ap_enable_reg_pp0_iter2, icmp_ln126_reg_280_pp0_iter1_reg)
    begin
    ...
    ret_V_fu_187_p2 <= std_logic_vector(signed(ap_const_lv11_7FF) + signed(trunc_ln1354_fu_183_p1));
    tmp_data_V_fu_233_p4 <= ((img_0_data_stream_V_2_dout & img_0_data_stream_V_1_dout) & img_0_data_stream_V_s_dout);
    trunc_ln1354_fu_183_p1 <= img_0_cols_V(11 - 1 downto 0);
    zext_ln879_fu_220_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(t_V_1_reg_156),11));
end behav;
