...
module Mat2AXIvideo (
        ...
        m_axis_video_TID,
        m_axis_video_TDEST,
        img_0_data_stream_V_s_dout,
        img_0_data_stream_V_s_empty_n,
        img_0_data_stream_V_s_read,
        img_0_data_stream_V_1_dout,
        img_0_data_stream_V_1_empty_n,
        img_0_data_stream_V_1_read,
        img_0_data_stream_V_2_dout,
        img_0_data_stream_V_2_empty_n,
        img_0_data_stream_V_2_read
);
...
input  [7:0] img_0_data_stream_V_s_dout;
input   img_0_data_stream_V_s_empty_n;
output   img_0_data_stream_V_s_read;
input  [7:0] img_0_data_stream_V_1_dout;
input   img_0_data_stream_V_1_empty_n;
output   img_0_data_stream_V_1_read;
input  [7:0] img_0_data_stream_V_2_dout;
input   img_0_data_stream_V_2_empty_n;
output   img_0_data_stream_V_2_read;

reg ap_done;
reg ap_idle;
reg ap_ready;
reg img_0_data_stream_V_s_read;
reg img_0_data_stream_V_1_read;
reg img_0_data_stream_V_2_read;
...
reg   [31:0] img_0_rows_V;
reg   [31:0] img_0_cols_V;
...
reg   [9:0] t_V_1_reg_156;
wire   [9:0] empty_fu_171_p1;
reg   [9:0] empty_reg_256;
reg    ap_block_state1;
wire   [9:0] empty_116_fu_179_p1;
reg   [9:0] empty_116_reg_261;
wire   [10:0] ret_V_fu_187_p2;
reg   [10:0] ret_V_reg_266;
wire   [0:0] icmp_ln125_fu_198_p2;
wire    ap_CS_fsm_state2;
reg    ap_block_state2;
wire   [9:0] i_V_fu_203_p2;
reg   [9:0] i_V_reg_275;
wire   [0:0] icmp_ln126_fu_209_p2;
...
wire   [10:0] trunc_ln1354_fu_183_p1;
wire   [10:0] zext_ln879_fu_220_p1;
reg   [3:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
#0 img_0_rows_V = 32'd600;
#0 img_0_cols_V = 32'd800;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == AXI_video_strm_V_keep_V_1_vld_out) & (1'b1 == AXI_video_strm_V_keep_V_1_ack_out))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp0_stage0_subdone) & (1'b1 == ap_condition_pp0_exit_iter0_state3) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if ((~((2'd1 == AXI_video_strm_V_dest_V_1_state) | (2'd1 == AXI_video_strm_V_id_V_1_state) | (2'd1 == AXI_video_strm_V_last_V_1_state) | (2'd1 == AXI_video_strm_V_user_V_1_state) | (2'd1 == AXI_video_strm_V_strb_V_1_state) | (2'd1 == AXI_video_strm_V_keep_V_1_state) | (2'd1 == AXI_video_strm_V_data_V_1_state) | ((2'd3 == AXI_video_strm_V_data_V_1_state) & (m_axis_video_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_dest_V_1_state) & (m_axis_video_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_id_V_1_state) & (m_axis_video_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_last_V_1_state) & (m_axis_video_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_user_V_1_state) & (m_axis_video_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_strb_V_1_state) & (m_axis_video_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_keep_V_1_state) & (m_axis_video_TREADY == 1'b0))) & (icmp_ln125_fu_198_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln126_fu_209_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln126_reg_280 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln126_fu_209_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if ((icmp_ln126_fu_209_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln126_reg_280 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        img_0_data_stream_V_1_read = 1'b1;
    end else begin
        img_0_data_stream_V_1_read = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln126_reg_280 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        img_0_data_stream_V_2_read = 1'b1;
    end else begin
        img_0_data_stream_V_2_read = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln126_reg_280 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        img_0_data_stream_V_s_read = 1'b1;
    end else begin
        img_0_data_stream_V_s_read = 1'b0;
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln126_fu_209_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) & ~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln126_fu_209_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((icmp_ln126_reg_280 == 1'd0) & (img_0_data_stream_V_2_empty_n == 1'b0)) | ((icmp_ln126_reg_280 == 1'd0) & (img_0_data_stream_V_1_empty_n == 1'b0)) | ((icmp_ln126_reg_280 == 1'd0) & (img_0_data_stream_V_s_empty_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((1'b1 == ap_block_state5_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state4_io) | ((icmp_ln126_reg_280 == 1'd0) & (img_0_data_stream_V_2_empty_n == 1'b0)) | ((icmp_ln126_reg_280 == 1'd0) & (img_0_data_stream_V_1_empty_n == 1'b0)) | ((icmp_ln126_reg_280 == 1'd0) & (img_0_data_stream_V_s_empty_n == 1'b0)))));
end
...
always @ (*) begin
    ap_block_state4_pp0_stage0_iter1 = (((icmp_ln126_reg_280 == 1'd0) & (img_0_data_stream_V_2_empty_n == 1'b0)) | ((icmp_ln126_reg_280 == 1'd0) & (img_0_data_stream_V_1_empty_n == 1'b0)) | ((icmp_ln126_reg_280 == 1'd0) & (img_0_data_stream_V_s_empty_n == 1'b0)));
end
...
assign axi_last_V_fu_224_p2 = ((zext_ln879_fu_220_p1 == ret_V_reg_266) ? 1'b1 : 1'b0);

assign empty_116_fu_179_p1 = img_0_cols_V[9:0];

assign empty_fu_171_p1 = img_0_rows_V[9:0];

assign i_V_fu_203_p2 = (t_V_reg_145 + 10'd1);

assign icmp_ln125_fu_198_p2 = ((t_V_reg_145 == empty_reg_256) ? 1'b1 : 1'b0);

assign icmp_ln126_fu_209_p2 = ((t_V_1_reg_156 == empty_116_reg_261) ? 1'b1 : 1'b0);

assign j_V_fu_214_p2 = (t_V_1_reg_156 + 10'd1);
...
assign ret_V_fu_187_p2 = ($signed(11'd2047) + $signed(trunc_ln1354_fu_183_p1));

assign tmp_data_V_fu_233_p4 = {{{img_0_data_stream_V_2_dout}, {img_0_data_stream_V_1_dout}}, {img_0_data_stream_V_s_dout}};

assign trunc_ln1354_fu_183_p1 = img_0_cols_V[10:0];

assign zext_ln879_fu_220_p1 = t_V_1_reg_156;

always @ (posedge ap_clk) begin
    empty_reg_256[9:0] <= 10'b1001011000;
    empty_116_reg_261[9:0] <= 10'b1100100000;
    ret_V_reg_266[10:0] <= 11'b01100011111;
end
