...
set portList { 
	...
	{ re_V_ap_vld sc_in sc_logic 1 invld 4 } 
	{ zoom_factor_V_ap_vld sc_in sc_logic 1 invld 5 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"InputProcess" : [
			{"ID" : "1", "Name" : "dataflow_in_loop_out_U0"}],
		"OutputProcess" : [
			{"ID" : "1", "Name" : "dataflow_in_loop_out_U0"}],
		"Port" : [
			{"Name" : "img_0_data_stream_0_V", "Type" : "Fifo", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "dataflow_in_loop_out_U0", "Port" : "img_0_data_stream_0_V"}]},
			{"Name" : "img_0_data_stream_1_V", "Type" : "Fifo", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "dataflow_in_loop_out_U0", "Port" : "img_0_data_stream_1_V"}]},
			{"Name" : "img_0_data_stream_2_V", "Type" : "Fifo", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "dataflow_in_loop_out_U0", "Port" : "img_0_data_stream_2_V"}]},
			{"Name" : "im_V", "Type" : "None", "Direction" : "I"},
			{"Name" : "re_V", "Type" : "None", "Direction" : "I"},
			{"Name" : "zoom_factor_V", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_out_U0", "Parent" : "0", "Child" : ["2"],
		...
		"HasNonBlockingOperation" : "0",
		"InputProcess" : [
			{"ID" : "2", "Name" : "inner_proc_U0"}],
		"OutputProcess" : [
			{"ID" : "2", "Name" : "inner_proc_U0"}],
		"Port" : [
			{"Name" : "img_0_data_stream_0_V", "Type" : "Fifo", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "inner_proc_U0", "Port" : "img_0_data_stream_0_V"}]},
			{"Name" : "img_0_data_stream_1_V", "Type" : "Fifo", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "inner_proc_U0", "Port" : "img_0_data_stream_1_V"}]},
			{"Name" : "img_0_data_stream_2_V", "Type" : "Fifo", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "inner_proc_U0", "Port" : "img_0_data_stream_2_V"}]},
			{"Name" : "im_V", "Type" : "None", "Direction" : "I"},
			{"Name" : "v_assign", "Type" : "None", "Direction" : "I"},
			{"Name" : "re_V", "Type" : "None", "Direction" : "I"},
			{"Name" : "zoom_factor_V", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_out_U0.inner_proc_U0", "Parent" : "1", "Child" : ["3", "4", "5", "6", "7", "8"],
		"CDFG" : "inner_proc",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1",
		...
		"Port" : [
			...
			{"Name" : "re_V", "Type" : "None", "Direction" : "I"},
			{"Name" : "zoom_factor_V", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "3", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_out_U0.inner_proc_U0.video_mandelbrot_generator_mul_mul_14ns_17ns_31_1_1_U1", "Parent" : "2"},
	{"ID" : "4", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_out_U0.inner_proc_U0.video_mandelbrot_generator_mul_mul_18s_18s_36_1_1_U2", "Parent" : "2"},
	{"ID" : "5", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_out_U0.inner_proc_U0.video_mandelbrot_generator_mul_mul_18s_18s_36_1_1_U3", "Parent" : "2"},
	{"ID" : "6", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_out_U0.inner_proc_U0.video_mandelbrot_generator_mul_mul_18s_18s_36_1_1_U4", "Parent" : "2"},
	{"ID" : "7", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_out_U0.inner_proc_U0.video_mandelbrot_generator_mul_mul_18s_18s_36_1_1_U5", "Parent" : "2"},
	{"ID" : "8", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_out_U0.inner_proc_U0.video_mandelbrot_generator_mul_mul_19s_19s_38_1_1_U6", "Parent" : "2"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "547", "Max" : "3907"}
	, {"Name" : "Interval", "Min" : "547", "Max" : "3907"}
]}
