...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "video_mandelbrot_generator.autotvin.dat"
	set constFileTvOut       "video_mandelbrot_generator.autotvout.dat"
	set constFileHdlTvIn     "video_mandelbrot_generator.autohdltvin.dat"
	set constFileHdlTvOut    "video_mandelbrot_generator.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
