...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        t_V_reg_927 <= pal_rot_V;
        tmp_cast_reg_932[7 : 0] <= tmp_cast_fu_288_p1[7 : 0];
    end
end
...
assign tmp_2_fu_318_p2 = ($signed(t_V_reg_927) + $signed(8'd255));
...
always @ (posedge ap_clk) begin
    tmp_cast_reg_932[19:8] <= 12'b000000000000;
