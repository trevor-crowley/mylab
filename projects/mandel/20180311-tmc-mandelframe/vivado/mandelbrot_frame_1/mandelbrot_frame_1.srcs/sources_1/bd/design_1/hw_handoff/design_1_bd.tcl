...
proc create_root_design { parentCell } {
  ...
  set vid_io_out_ce [ create_bd_port -dir I -type ce vid_io_out_ce ]
  ...
  set mandelbrot_frame_0 [ create_bd_cell -type ip -vlnv tmc:user.org:mandelbrot_frame:0.3 mandelbrot_frame_0 ]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins mandelbrot_frame_0/ap_rst_n] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins v_tc_0/resetn]
  ...
  connect_bd_net -net vid_io_out_ce_1 [get_bd_ports vid_io_out_ce] [get_bd_pins mandelbrot_frame_0/ap_start] [get_bd_pins v_axi4s_vid_out_0/aclken] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_ce] [get_bd_pins v_tc_0/clken]
