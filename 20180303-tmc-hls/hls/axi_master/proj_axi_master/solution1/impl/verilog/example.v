...
(* CORE_GENERATION_INFO="example,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-2,HLS_INPUT_CLOCK=13.333300,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=11.666637,HLS_SYN_LAT=217,HLS_SYN_TPT=none,HLS_SYN_MEM=3,HLS_SYN_DSP=0,HLS_SYN_FF=648,HLS_SYN_LUT=1044}" *)
...
reg   [0:0] exitcond6_reg_244;
reg   [0:0] ap_reg_pp1_iter1_exitcond6_reg_244;
reg    a_blk_n_B;
...
wire   [0:0] a_BID;
wire   [0:0] a_BUSER;
reg   [5:0] indvar_reg_124;
reg   [5:0] ap_reg_pp0_iter1_indvar_reg_124;
wire    ap_block_state8_pp0_stage0_iter0;
reg    ap_block_state9_pp0_stage0_iter1;
wire    ap_block_state10_pp0_stage0_iter2;
reg    ap_block_pp0_stage0_11001;
reg   [5:0] indvar4_reg_147;
wire   [0:0] exitcond1_fu_158_p2;
reg   [0:0] ap_reg_pp0_iter1_exitcond1_reg_216;
wire   [5:0] indvar_next_fu_164_p2;
reg   [5:0] indvar_next_reg_220;
reg    ap_enable_reg_pp0_iter0;
reg   [31:0] a_read_reg_225;
reg    ap_sig_ioackin_a_AWREADY;
reg    ap_block_state12_io;
wire   [5:0] i_1_fu_181_p2;
reg   [5:0] i_1_reg_234;
reg   [5:0] buff_addr_1_reg_239;
...
wire   [5:0] indvar_next5_fu_205_p2;
reg    ap_enable_reg_pp1_iter0;
wire   [31:0] buff_q0;
reg   [31:0] buff_load_1_reg_258;
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp1_stage0_subdone) & (1'b1 == ap_condition_pp1_exit_iter0_state14) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
            ap_enable_reg_pp1_iter0 <= 1'b0;
        end else if (((1'b0 == ap_block_state12_io) & (1'b1 == ap_CS_fsm_state12) & (exitcond_fu_175_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_state12) & (exitcond_fu_175_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if (((ap_enable_reg_pp1_iter2 == 1'b1) & (ap_reg_pp1_iter1_exitcond6_reg_244 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state12_io) & (1'b1 == ap_CS_fsm_state12) & (exitcond_fu_175_p2 == 1'd1))) begin
        indvar4_reg_147 <= 6'd0;
    end else if (((1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (exitcond6_fu_199_p2 == 1'd0))) begin
        indvar4_reg_147 <= indvar_next5_fu_205_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (exitcond1_reg_216 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (exitcond1_reg_216 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state12_io) & (1'b1 == ap_CS_fsm_state12) & (exitcond_fu_175_p2 == 1'd0))) begin
        buff_addr_1_reg_239 <= tmp_1_fu_187_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (exitcond6_reg_244 == 1'd0))) begin
...
always @ (*) begin
    if (((ap_reg_ioackin_a_AWREADY == 1'b0) & (1'b1 == ap_CS_fsm_state12) & (exitcond_fu_175_p2 == 1'd1))) begin
        a_AWVALID = 1'b1;
    end else begin
        a_AWVALID = 1'b0;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp1_stage0_01001) & (ap_reg_ioackin_a_WREADY == 1'b0) & (ap_enable_reg_pp1_iter2 == 1'b1) & (ap_reg_pp1_iter1_exitcond6_reg_244 == 1'd0))) begin
        a_WVALID = 1'b1;
    end else begin
        a_WVALID = 1'b0;
    end
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (exitcond1_reg_216 == 1'd0) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp1_iter2 == 1'b1) & (1'b0 == ap_block_pp1_stage0) & (ap_reg_pp1_iter1_exitcond6_reg_244 == 1'd0))) begin
...
always @ (*) begin
    if ((exitcond1_fu_158_p2 == 1'd1)) begin
...
always @ (*) begin
    if ((exitcond6_fu_199_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0))) begin
        buff_address0 = tmp_4_fu_211_p1;
    end else if ((1'b1 == ap_CS_fsm_state13)) begin
        buff_address0 = buff_addr_1_reg_239;
    end else if ((1'b1 == ap_CS_fsm_state12)) begin
        buff_address0 = tmp_1_fu_187_p1;
    end else if (((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0))) begin
        buff_address0 = tmp_fu_170_p1;
    end else begin
        buff_address0 = 'bx;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state13) | ((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (ap_reg_pp0_iter1_exitcond1_reg_216 == 1'd0)))) begin
        buff_we0 = 1'b1;
    end else begin
        buff_we0 = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((ap_enable_reg_pp0_iter1 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (exitcond1_fu_158_p2 == 1'd1)) & ~((ap_enable_reg_pp0_iter1 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter1 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (exitcond1_fu_158_p2 == 1'd1)))) begin
        ...
        ap_ST_fsm_state12 : begin
            ...
            end else if (((1'b0 == ap_block_state12_io) & (1'b1 == ap_CS_fsm_state12) & (exitcond_fu_175_p2 == 1'd0))) begin
        ...
        ap_ST_fsm_pp1_stage0 : begin
            if ((~((1'b0 == ap_block_pp1_stage0_subdone) & (ap_enable_reg_pp1_iter1 == 1'b0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (exitcond6_fu_199_p2 == 1'd1)) & ~((1'b0 == ap_block_pp1_stage0_subdone) & (ap_enable_reg_pp1_iter1 == 1'b0) & (ap_enable_reg_pp1_iter2 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp1_stage0;
            end else if ((((1'b0 == ap_block_pp1_stage0_subdone) & (ap_enable_reg_pp1_iter1 == 1'b0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (exitcond6_fu_199_p2 == 1'd1)) | ((1'b0 == ap_block_pp1_stage0_subdone) & (ap_enable_reg_pp1_iter1 == 1'b0) & (ap_enable_reg_pp1_iter2 == 1'b1)))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((1'b0 == a_RVALID) & (ap_enable_reg_pp0_iter1 == 1'b1) & (exitcond1_reg_216 == 1'd0));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((1'b0 == a_RVALID) & (ap_enable_reg_pp0_iter1 == 1'b1) & (exitcond1_reg_216 == 1'd0));
end
...
always @ (*) begin
    ap_block_state12_io = ((ap_sig_ioackin_a_AWREADY == 1'b0) & (exitcond_fu_175_p2 == 1'd1));
end
...
always @ (*) begin
    ap_block_state16_io = ((ap_sig_ioackin_a_WREADY == 1'b0) & (ap_reg_pp1_iter1_exitcond6_reg_244 == 1'd0));
end
...
always @ (*) begin
    ap_block_state9_pp0_stage0_iter1 = ((1'b0 == a_RVALID) & (exitcond1_reg_216 == 1'd0));
end
...
assign exitcond1_fu_158_p2 = ((ap_phi_mux_indvar_phi_fu_128_p4 == 6'd50) ? 1'b1 : 1'b0);

assign exitcond6_fu_199_p2 = ((indvar4_reg_147 == 6'd50) ? 1'b1 : 1'b0);

assign exitcond_fu_175_p2 = ((i_reg_136 == 6'd50) ? 1'b1 : 1'b0);

assign i_1_fu_181_p2 = (i_reg_136 + 6'd1);

assign indvar_next5_fu_205_p2 = (indvar4_reg_147 + 6'd1);

assign indvar_next_fu_164_p2 = (ap_phi_mux_indvar_phi_fu_128_p4 + 6'd1);

assign tmp_1_fu_187_p1 = i_reg_136;

assign tmp_2_fu_192_p2 = (buff_q0 + 32'd100);

assign tmp_4_fu_211_p1 = indvar4_reg_147;

assign tmp_fu_170_p1 = ap_reg_pp0_iter1_indvar_reg_124;
