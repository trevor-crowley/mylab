...
#ifndef __mandelbrot_frame_dEe__HH__
#define __mandelbrot_frame_dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(mandelbrot_frame_dEe) {
    ...
    SC_CTOR(mandelbrot_frame_dEe):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
