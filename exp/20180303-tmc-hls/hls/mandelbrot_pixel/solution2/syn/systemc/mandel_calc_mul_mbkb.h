...
#ifndef __mandel_calc_mul_mbkb__HH__
#define __mandel_calc_mul_mbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(mandel_calc_mul_mbkb) {
    ...
    SC_CTOR(mandel_calc_mul_mbkb):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
