...
architecture behav of design_1_v_tpg_0_0_MultiPixStream2AXIvi is 
    ...
    signal tmp_92_reg_399 : STD_LOGIC_VECTOR (13 downto 0);
    ...
    signal tmp_93_reg_404 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_87_cast_fu_258_p1 : STD_LOGIC_VECTOR (13 downto 0);
    signal tmp_87_cast_reg_409 : STD_LOGIC_VECTOR (13 downto 0);
    ...
    signal tmp_8_fu_349_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_7_fu_342_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal p_019_0_2_fu_335_p3 : STD_LOGIC_VECTOR (23 downto 0);
    signal tmp_9_fu_356_p3 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
    grp_reg_unsigned_short_s_fu_223 : component design_1_v_tpg_0_0_reg_unsigned_short_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_reg_unsigned_short_s_fu_229 : component design_1_v_tpg_0_0_reg_unsigned_short_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    exitcond1_fu_272_p2 <= "1" when (i_cast_fu_268_p1 = tmp_93_reg_404) else "0";
    exitcond2_fu_287_p2 <= "1" when (j_cast_fu_283_p1 = tmp_92_reg_399) else "0";
    ...
    tmp_7_fu_342_p3 <= 
        ...
        tmp_87_cast_fu_258_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_78_fu_252_p2),14));
    ...
    tmp_data_V_fu_364_p5 <= (tmp_9_fu_356_p3 & p_019_0_2_fu_335_p3(7 downto 0));
    tmp_last_V_fu_298_p2 <= "1" when (j_cast_fu_283_p1 = tmp_87_cast_reg_409) else "0";
end behav;
