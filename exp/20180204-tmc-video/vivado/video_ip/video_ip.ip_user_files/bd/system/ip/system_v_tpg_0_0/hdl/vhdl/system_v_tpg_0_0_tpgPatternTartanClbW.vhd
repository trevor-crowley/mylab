...
entity system_v_tpg_0_0_tpgPatternTartanClbW_rom is 
    generic(
             dwidth     : integer := 3; 
             awidth     : integer := 6; 
             mem_size    : integer := 64
...
architecture rtl of system_v_tpg_0_0_tpgPatternTartanClbW_rom is 
...
entity system_v_tpg_0_0_tpgPatternTartanClbW is
    generic (
        DataWidth : INTEGER := 3;
...
architecture arch of system_v_tpg_0_0_tpgPatternTartanClbW is
    component system_v_tpg_0_0_tpgPatternTartanClbW_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    system_v_tpg_0_0_tpgPatternTartanClbW_rom_U :  component system_v_tpg_0_0_tpgPatternTartanClbW_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
