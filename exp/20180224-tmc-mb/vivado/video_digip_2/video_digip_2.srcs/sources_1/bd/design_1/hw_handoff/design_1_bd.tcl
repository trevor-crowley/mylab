...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.CONST_VAL {1983} \
   CONFIG.CONST_WIDTH {12} \
 ] $xlconstant_0

  # Create port connections
  connect_bd_net -net clk_wiz_0_clk_vid [get_bd_pins clk_wiz_0/clk_vid] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins rgb2vga_0/PixelClk] [get_bd_pins v_tc_0/clk]
  ...
  connect_bd_net -net v_tc_0_active_video_out [get_bd_pins rgb2vga_0/rgb_pVDE] [get_bd_pins v_tc_0/active_video_out]
  connect_bd_net -net v_tc_0_hsync_out [get_bd_pins rgb2vga_0/rgb_pHSync] [get_bd_pins v_tc_0/hsync_out]
  connect_bd_net -net v_tc_0_vsync_out [get_bd_pins rgb2vga_0/rgb_pVSync] [get_bd_pins v_tc_0/vsync_out]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins rgb2vga_0/rgb_pData] [get_bd_pins xlconstant_0/dout]
