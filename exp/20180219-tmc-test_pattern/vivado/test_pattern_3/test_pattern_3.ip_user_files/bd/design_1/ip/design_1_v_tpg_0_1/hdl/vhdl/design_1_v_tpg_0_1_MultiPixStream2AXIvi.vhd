...
entity design_1_v_tpg_0_1_MultiPixStream2AXIvi is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of design_1_v_tpg_0_1_MultiPixStream2AXIvi is 
    ...
    signal exitcond4_reg_430 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal ap_reg_pp0_iter1_exitcond4_reg_430 : STD_LOGIC_VECTOR (0 downto 0);
    signal j_reg_212 : STD_LOGIC_VECTOR (12 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal tmp_34_fu_244_p1 : STD_LOGIC_VECTOR (13 downto 0);
    signal tmp_34_reg_399 : STD_LOGIC_VECTOR (13 downto 0);
    ...
    signal tmp_35_fu_248_p1 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_35_reg_404 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_39_cast_fu_258_p1 : STD_LOGIC_VECTOR (13 downto 0);
    signal tmp_39_cast_reg_409 : STD_LOGIC_VECTOR (13 downto 0);
    signal sel_tmp2_fu_262_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal exitcond3_fu_272_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_33_fu_240_p1 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_19_fu_252_p2 : STD_LOGIC_VECTOR (12 downto 0);
    ...
    signal tmp_21_fu_349_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_20_fu_342_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal p_019_0_2_fu_335_p3 : STD_LOGIC_VECTOR (23 downto 0);
    signal tmp_22_fu_356_p3 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
    grp_reg_unsigned_short_s_fu_223 : component design_1_v_tpg_0_1_reg_unsigned_short_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_reg_unsigned_short_s_fu_229 : component design_1_v_tpg_0_1_reg_unsigned_short_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_const_logic_1 = ap_condition_pp0_exit_iter0_state4) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                    ap_enable_reg_pp0_iter0 <= ap_const_logic_0;
                elsif ((not(((ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_dest_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_id_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_last_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_user_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_strb_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_keep_V_1_ack_in))) and (exitcond3_fu_272_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((exitcond4_fu_287_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond4_reg_430 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ap_reg_pp0_iter1_exitcond4_reg_430 <= exitcond4_reg_430;
                exitcond4_reg_430 <= exitcond4_fu_287_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_state2_on_subcall_done) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                tmp_34_reg_399 <= tmp_34_fu_244_p1;
                tmp_35_reg_404 <= tmp_35_fu_248_p1;
                tmp_39_cast_reg_409 <= tmp_39_cast_fu_258_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond4_fu_287_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                tmp_last_V_reg_439 <= tmp_last_V_fu_298_p2;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, AXI_video_strm_V_data_V_1_ack_in, AXI_video_strm_V_keep_V_1_ack_in, AXI_video_strm_V_strb_V_1_ack_in, AXI_video_strm_V_user_V_1_ack_in, AXI_video_strm_V_last_V_1_ack_in, AXI_video_strm_V_id_V_1_ack_in, AXI_video_strm_V_dest_V_1_ack_in, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, ap_CS_fsm_state2, ap_block_state2_on_subcall_done, exitcond3_fu_272_p2, ap_CS_fsm_state3, exitcond4_fu_287_p2, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_pp0_stage0 => 
                if ((not(((exitcond4_fu_287_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) and not(((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))))) then
                    ap_NS_fsm <= ap_ST_fsm_pp0_stage0;
                elsif ((((exitcond4_fu_287_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1)) or ((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)))) then
    ...
    AXI_video_strm_V_data_V_1_vld_in_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, exitcond4_reg_430, ap_block_pp0_stage0_11001)
    begin
        if (((exitcond4_reg_430 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    AXI_video_strm_V_dest_V_1_vld_in_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, exitcond4_reg_430, ap_block_pp0_stage0_11001)
    begin
        if (((exitcond4_reg_430 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    AXI_video_strm_V_id_V_1_vld_in_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, exitcond4_reg_430, ap_block_pp0_stage0_11001)
    begin
        if (((exitcond4_reg_430 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    AXI_video_strm_V_keep_V_1_vld_in_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, exitcond4_reg_430, ap_block_pp0_stage0_11001)
    begin
        if (((exitcond4_reg_430 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    AXI_video_strm_V_last_V_1_vld_in_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, exitcond4_reg_430, ap_block_pp0_stage0_11001)
    begin
        if (((exitcond4_reg_430 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    AXI_video_strm_V_strb_V_1_vld_in_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, exitcond4_reg_430, ap_block_pp0_stage0_11001)
    begin
        if (((exitcond4_reg_430 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    AXI_video_strm_V_user_V_1_vld_in_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, exitcond4_reg_430, ap_block_pp0_stage0_11001)
    begin
        if (((exitcond4_reg_430 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_enable_reg_pp0_iter1, exitcond4_reg_430, strmPix_V_val_0_V0_status)
    begin
                ap_block_pp0_stage0_01001 <= ((exitcond4_reg_430 = ap_const_lv1_0) and (strmPix_V_val_0_V0_status = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_enable_reg_pp0_iter1, exitcond4_reg_430, ap_enable_reg_pp0_iter2, strmPix_V_val_0_V0_status, ap_block_state5_io, ap_block_state6_io)
    begin
                ap_block_pp0_stage0_11001 <= (((ap_const_boolean_1 = ap_block_state6_io) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and ((ap_const_boolean_1 = ap_block_state5_io) or ((exitcond4_reg_430 = ap_const_lv1_0) and (strmPix_V_val_0_V0_status = ap_const_logic_0)))));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_enable_reg_pp0_iter1, exitcond4_reg_430, ap_enable_reg_pp0_iter2, strmPix_V_val_0_V0_status, ap_block_state5_io, ap_block_state6_io)
    begin
                ap_block_pp0_stage0_subdone <= (((ap_const_boolean_1 = ap_block_state6_io) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and ((ap_const_boolean_1 = ap_block_state5_io) or ((exitcond4_reg_430 = ap_const_lv1_0) and (strmPix_V_val_0_V0_status = ap_const_logic_0)))));
    end process;
    ...
    ap_block_state5_io_assign_proc : process(AXI_video_strm_V_data_V_1_ack_in, exitcond4_reg_430)
    begin
                ap_block_state5_io <= ((exitcond4_reg_430 = ap_const_lv1_0) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in));
    end process;


    ap_block_state5_pp0_stage0_iter1_assign_proc : process(exitcond4_reg_430, strmPix_V_val_0_V0_status)
    begin
                ap_block_state5_pp0_stage0_iter1 <= ((exitcond4_reg_430 = ap_const_lv1_0) and (strmPix_V_val_0_V0_status = ap_const_logic_0));
    end process;


    ap_block_state6_io_assign_proc : process(AXI_video_strm_V_data_V_1_ack_in, ap_reg_pp0_iter1_exitcond4_reg_430)
    begin
                ap_block_state6_io <= ((ap_reg_pp0_iter1_exitcond4_reg_430 = ap_const_lv1_0) and (ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in));
    end process;

        ap_block_state6_pp0_stage0_iter2 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_condition_pp0_exit_iter0_state4_assign_proc : process(exitcond4_fu_287_p2)
    begin
        if ((exitcond4_fu_287_p2 = ap_const_lv1_1)) then 
    ...
    ap_ready_assign_proc : process(AXI_video_strm_V_data_V_1_ack_in, AXI_video_strm_V_keep_V_1_ack_in, AXI_video_strm_V_strb_V_1_ack_in, AXI_video_strm_V_user_V_1_ack_in, AXI_video_strm_V_last_V_1_ack_in, AXI_video_strm_V_id_V_1_ack_in, AXI_video_strm_V_dest_V_1_ack_in, exitcond3_fu_272_p2, ap_CS_fsm_state3)
    begin
        if ((not(((ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_dest_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_id_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_last_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_user_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_strb_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_keep_V_1_ack_in))) and (exitcond3_fu_272_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    exitcond3_fu_272_p2 <= "1" when (i_cast_fu_268_p1 = tmp_35_reg_404) else "0";
    exitcond4_fu_287_p2 <= "1" when (j_cast_fu_283_p1 = tmp_34_reg_399) else "0";
    ...
    m_axis_video_TDATA_blk_n_assign_proc : process(AXI_video_strm_V_data_V_1_state, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, exitcond4_reg_430, ap_enable_reg_pp0_iter2, ap_reg_pp0_iter1_exitcond4_reg_430)
    begin
        if ((((ap_reg_pp0_iter1_exitcond4_reg_430 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((exitcond4_reg_430 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)))) then 
    ...
    strmPix_V_val_0_V0_update_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, exitcond4_reg_430, ap_block_pp0_stage0_11001)
    begin
        if (((exitcond4_reg_430 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    strmPix_V_val_0_V_blk_n_assign_proc : process(strmPix_V_val_0_V_empty_n, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, exitcond4_reg_430)
    begin
        if (((exitcond4_reg_430 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    strmPix_V_val_1_V_blk_n_assign_proc : process(strmPix_V_val_1_V_empty_n, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, exitcond4_reg_430)
    begin
        if (((exitcond4_reg_430 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    strmPix_V_val_2_V_blk_n_assign_proc : process(strmPix_V_val_2_V_empty_n, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, exitcond4_reg_430)
    begin
        if (((exitcond4_reg_430 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    tmp_19_fu_252_p2 <= std_logic_vector(signed(ap_const_lv13_1FFF) + signed(tmp_33_fu_240_p1));
    tmp_20_fu_342_p3 <= 
    ...
    tmp_22_fu_356_p3 <= (tmp_21_fu_349_p3 & tmp_20_fu_342_p3);
    tmp_33_fu_240_p1 <= grp_reg_unsigned_short_s_fu_229_ap_return(13 - 1 downto 0);
    tmp_34_fu_244_p1 <= grp_reg_unsigned_short_s_fu_229_ap_return(14 - 1 downto 0);
    tmp_35_fu_248_p1 <= grp_reg_unsigned_short_s_fu_223_ap_return(13 - 1 downto 0);
        tmp_39_cast_fu_258_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_19_fu_252_p2),14));

    tmp_data_V_fu_364_p5 <= (tmp_22_fu_356_p3 & p_019_0_2_fu_335_p3(7 downto 0));
    tmp_last_V_fu_298_p2 <= "1" when (j_cast_fu_283_p1 = tmp_39_cast_reg_409) else "0";
end behav;
