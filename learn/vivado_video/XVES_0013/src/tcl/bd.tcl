...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net v_tpg_0_m_axis_video [get_bd_intf_ports AXIS_out] [get_bd_intf_pins v_tpg_0/m_axis_video]

  # Create port connections
  connect_bd_net -net aclk_0_1 [get_bd_ports aclk_40MHz] [get_bd_pins axi_vip_0/aclk] [get_bd_pins v_tpg_0/ap_clk]
