...
module AXI4S_to_Vid_Out_bd_v_tpg_0_0_tpgPatternColorBars (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
AXI4S_to_Vid_Out_bd_v_tpg_0_0_tpgPatternCheckerBoa_tpgBarSelYuv_y352 #(
    .DataWidth( 8 ),
    .AddressRange( 8 ),
    .AddressWidth( 3 ))
tpgBarSelYuv_y_U(
...
AXI4S_to_Vid_Out_bd_v_tpg_0_0_tpgPatternCheckerBoa_tpgBarSelYuv_v348 #(
    .DataWidth( 8 ),
    .AddressRange( 8 ),
    .AddressWidth( 3 ))
tpgBarSelYuv_v_U(
...
AXI4S_to_Vid_Out_bd_v_tpg_0_0_tpgPatternCheckerBoa_tpgBarSelYuv_u350 #(
    .DataWidth( 8 ),
    .AddressRange( 8 ),
    .AddressWidth( 3 ))
tpgBarSelYuv_u_U(
...
endmodule //AXI4S_to_Vid_Out_bd_v_tpg_0_0_tpgPatternColorBars
