...
#
# Generated by export_simulation on Thu Jan 23 23:51:03 EST 2020
#
################################################################################
...
'-reset_run' switch to the './AXI4S_to_Vid_Out_bd.sh' script.

./AXI4S_to_Vid_Out_bd.sh -reset_run
...
./AXI4S_to_Vid_Out_bd.sh -noclean_files

For more information on the script, please type './AXI4S_to_Vid_Out_bd.sh -help'.
