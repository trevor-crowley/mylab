...
#
# create_proj.tcl: Tcl script for re-creating project 'Sim_Rd_PPM'
#
#
...
add_files -fileset sim_1 -norecurse -scan_for_includes ./src/sim/VHDL
import_files -fileset sim_1 -norecurse ./src/sim/VHDL
