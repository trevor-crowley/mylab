...
if {[file isfile video_pattern_generator.autotvin.dat]} {
	file delete -force video_pattern_generator.autotvin.dat
}

if {[file isfile video_pattern_generator.autotvout.dat]} {
	file delete -force video_pattern_generator.autotvout.dat
}
