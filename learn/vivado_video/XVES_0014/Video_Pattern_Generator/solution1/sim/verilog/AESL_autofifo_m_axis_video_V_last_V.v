...
module AESL_autofifo_m_axis_video_V_last_V (
    clk,
    reset,
    if_empty_n,
    if_read,
...
//------------------------Parameter----------------------
localparam
	TV_IN	=	"../tv/cdatafile/c.video_pattern_generator.autotvin_m_axis_video_V_last_V.dat",
	TV_OUT	=	"../tv/rtldatafile/rtl.video_pattern_generator.autotvout_m_axis_video_V_last_V.dat";
