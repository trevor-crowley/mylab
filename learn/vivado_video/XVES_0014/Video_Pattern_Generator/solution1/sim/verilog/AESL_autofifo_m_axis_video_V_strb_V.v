...
module AESL_autofifo_m_axis_video_V_strb_V (
    clk,
    reset,
    if_empty_n,
    if_read,
...
//------------------------Parameter----------------------
localparam
	TV_IN	=	"../tv/cdatafile/c.video_pattern_generator.autotvin_m_axis_video_V_strb_V.dat",
	TV_OUT	=	"../tv/rtldatafile/rtl.video_pattern_generator.autotvout_m_axis_video_V_strb_V.dat";

//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 3;
parameter ADDR_WIDTH = 32'd 20;
parameter DEPTH = 32'd 480000;
