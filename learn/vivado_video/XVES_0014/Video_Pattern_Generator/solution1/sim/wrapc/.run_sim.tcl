...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "video_pattern_generator.autotvin.dat"
	set constFileTvOut       "video_pattern_generator.autotvout.dat"
	set constFileHdlTvIn     "video_pattern_generator.autohdltvin.dat"
	set constFileHdlTvOut    "video_pattern_generator.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
