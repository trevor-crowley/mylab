...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module AXI4S_bd_v_tpg_0_0_tpgPatternRainbow_tpgSinTableArray_9bi_rom (
...
initial begin
    $readmemh("./AXI4S_bd_v_tpg_0_0_tpgPatternRainbow_tpgSinTableArray_9bi_rom.dat", ram0);
    $readmemh("./AXI4S_bd_v_tpg_0_0_tpgPatternRainbow_tpgSinTableArray_9bi_rom.dat", ram1);
    $readmemh("./AXI4S_bd_v_tpg_0_0_tpgPatternRainbow_tpgSinTableArray_9bi_rom.dat", ram2);
end
...
`timescale 1 ns / 1 ps
module AXI4S_bd_v_tpg_0_0_tpgPatternRainbow_tpgSinTableArray_9bi(
    reset,
    clk,
    address0,
    ce0,
...
AXI4S_bd_v_tpg_0_0_tpgPatternRainbow_tpgSinTableArray_9bi_rom AXI4S_bd_v_tpg_0_0_tpgPatternRainbow_tpgSinTableArray_9bi_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
