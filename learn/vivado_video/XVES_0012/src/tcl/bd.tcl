...
################################################################
# This is a generated script based on design: AXI4S_to_Vid_Out_bd
#
...
proc create_root_design { parentCell } {
  ...
  set_property CONFIG.ASSOCIATED_RESET {aresetn_0} [get_bd_ports /aclk_40MHz]
  set aresetn_1 [ create_bd_port -dir I -type rst aresetn_1 ]
  set_property CONFIG.ASSOCIATED_RESET {aresetn_1:aresetn_1} [get_bd_ports /aclk_20MHz]
  ...
  connect_bd_net -net aclk_0_1 [get_bd_ports aclk_40MHz] [get_bd_pins axi_vip_0/aclk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins v_tc_0/clk] [get_bd_pins v_tpg_0/ap_clk]
  connect_bd_net -net aresetn_0_1 [get_bd_ports aresetn_0] [get_bd_pins axi_vip_0/aresetn] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins v_tc_0/resetn] [get_bd_pins v_tpg_0/ap_rst_n]
