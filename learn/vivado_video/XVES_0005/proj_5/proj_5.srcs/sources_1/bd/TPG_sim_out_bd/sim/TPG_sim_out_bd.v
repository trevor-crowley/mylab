...
//Command     : generate_target TPG_sim_out_bd.bd
//Design      : TPG_sim_out_bd
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "TPG_sim_out_bd,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=TPG_sim_out_bd,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=2,numReposBlks=2,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "TPG_sim_out_bd.hwdef" *) 
module TPG_sim_out_bd
   (aclk_50MHz,
    aresetn_0,
    tpg_tdata,
    tpg_tlast,
    ...
    tpg_tuser,
    tpg_tvalid);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.ACLK_50MHZ CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.ACLK_50MHZ, ASSOCIATED_RESET aresetn_0, CLK_DOMAIN TPG_sim_out_bd_aclk_50MHz, FREQ_HZ 50000000, INSERT_VIP 0, PHASE 0.000" *) input aclk_50MHz;
  ...
  TPG_sim_out_bd_axi_vip_0_0 axi_vip_0
       (.aclk(aclk_0_1),
        .aresetn(aresetn_0_1),
  ...
  TPG_sim_out_bd_v_tpg_0_0 v_tpg_0
       (.ap_clk(aclk_0_1),
